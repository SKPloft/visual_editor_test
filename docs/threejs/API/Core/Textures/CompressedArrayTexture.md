...
Source URL: https://threejs.org/docs/pages/CompressedArrayTexture.html
...
### new [CompressedArrayTexture](#CompressedArrayTexture)( mipmaps : Array.<Object>, width : number, height : number, depth : number, format : number, type : number )
...
### .[isCompressedArrayTexture](#isCompressedArrayTexture) : boolean (readonly)
