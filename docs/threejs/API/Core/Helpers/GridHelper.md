Title: GridHelper
Source URL: https://threejs.org/docs/pages/GridHelper.html
...
### new [GridHelper](#GridHelper)( size : number, divisions : number, color1 : number | [Color](Color.html) | string, color2 : number | [Color](Color.html) | string )
