Title: Shape
Source URL: https://threejs.org/docs/pages/Shape.html
...
### new [Shape](#Shape)( points : Array.<[Vector2](Vector2.html)\> )
...
### .[holes](#holes) : Array.<[Path](Path.html)\> (readonly)
...
### .[extractPoints](#extractPoints)( divisions : number ) : Object
...
### .[getPointsHoles](#getPointsHoles)( divisions : number ) : Array.<Array.<[Vector2](Vector2.html)\>>
