Title: AnimationClip
Source URL: https://threejs.org/docs/pages/AnimationClip.html
...
### new [AnimationClip](#AnimationClip)( name : string, duration : number, tracks : Array.<[KeyframeTrack](KeyframeTrack.html)\>, blendMode : [NormalAnimationBlendMode](global.html#NormalAnimationBlendMode) | [AdditiveAnimationBlendMode](global.html#AdditiveAnimationBlendMode) )
...
### .[tracks](#tracks) : Array.<[KeyframeTrack](KeyframeTrack.html)\>
...
### .[clone](#clone)() : [AnimationClip](AnimationClip.html)

Returns a new animation clip with copied values from this instance.

**Returns:** A clone of this instance.

### .[optimize](#optimize)() : [AnimationClip](AnimationClip.html)
...
### .[resetDuration](#resetDuration)() : [AnimationClip](AnimationClip.html)
...
### .[trim](#trim)() : [AnimationClip](AnimationClip.html)
...
### .[CreateClipsFromMorphTargetSequences](#.CreateClipsFromMorphTargetSequences)( morphTargets : Array.<Object>, fps : number, noLoop : boolean ) : Array.<[AnimationClip](AnimationClip.html)\>
...
### .[CreateFromMorphTargetSequence](#.CreateFromMorphTargetSequence)( name : string, morphTargetSequence : Array.<Object>, fps : number, noLoop : boolean ) : [AnimationClip](AnimationClip.html)
...
### .[findByName](#.findByName)( objectOrClipArray : Array.<[AnimationClip](AnimationClip.html)\> | [Object3D](Object3D.html), name : string ) : [AnimationClip](AnimationClip.html)
...
### .[parse](#.parse)( json : Object ) : [AnimationClip](AnimationClip.html)
...
### .[parseAnimation](#.parseAnimation)( animation : Object, bones : Array.<[Bone](Bone.html)\> ) : [AnimationClip](AnimationClip.html)
...
### .[toJSON](#.toJSON)( clip : [AnimationClip](AnimationClip.html) ) : Object
