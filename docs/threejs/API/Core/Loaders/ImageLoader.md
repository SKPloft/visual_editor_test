Title: ImageLoader
Source URL: https://threejs.org/docs/pages/ImageLoader.html
...
### new [ImageLoader](#ImageLoader)( manager : [LoadingManager](LoadingManager.html) )
...
### .[load](#load)( url : string, onLoad : function, onProgress : [onProgressCallback](global.html#onProgressCallback), onError : [onErrorCallback](global.html#onErrorCallback) ) : Image
