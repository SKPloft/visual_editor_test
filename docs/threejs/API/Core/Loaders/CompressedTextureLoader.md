...
Source URL: https://threejs.org/docs/pages/CompressedTextureLoader.html
...
### new [CompressedTextureLoader](#CompressedTextureLoader)( manager : [LoadingManager](LoadingManager.html) ) (abstract)
...
### .[load](#load)( url : string, onLoad : function, onProgress : [onProgressCallback](global.html#onProgressCallback), onError : [onErrorCallback](global.html#onErrorCallback) ) : [CompressedTexture](CompressedTexture.html)
