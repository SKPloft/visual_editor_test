...
Source URL: https://threejs.org/docs/pages/ImageBitmapLoader.html
...
### new [ImageBitmapLoader](#ImageBitmapLoader)( manager : [LoadingManager](LoadingManager.html) )
...
### .[isImageBitmapLoader](#isImageBitmapLoader) : boolean (readonly)
...
### .[abort](#abort)() : [ImageBitmapLoader](ImageBitmapLoader.html)
...
### .[setOptions](#setOptions)( options : Object ) : [ImageBitmapLoader](ImageBitmapLoader.html)
