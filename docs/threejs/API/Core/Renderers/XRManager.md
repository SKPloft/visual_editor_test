Title: XRManager
Source URL: https://threejs.org/docs/pages/XRManager.html
...
### new [XRManager](#XRManager)( renderer : [Renderer](Renderer.html), multiview : boolean )
...
### .[cameraAutoUpdate](#cameraAutoUpdate) : boolean
...
### .[isPresenting](#isPresenting) : boolean (readonly)
...
### .[createCylinderLayer](#createCylinderLayer)( radius : number, centralAngle : number, aspectratio : number, translation : [Vector3](Vector3.html), quaternion : [Quaternion](Quaternion.html), pixelwidth : number, pixelheight : number, rendercall : function, attributes : Object ) : [Mesh](Mesh.html)
...
### .[createQuadLayer](#createQuadLayer)( width : number, height : number, translation : [Vector3](Vector3.html), quaternion : [Quaternion](Quaternion.html), pixelwidth : number, pixelheight : number, rendercall : function, attributes : Object ) : [Mesh](Mesh.html)
...
### .[getBinding](#getBinding)() : XRWebGLBinding
...
### .[getCamera](#getCamera)() : [ArrayCamera](ArrayCamera.html)

Returns the XR camera.

**Returns:** The XR camera.

### .[getController](#getController)( index : number ) : [Group](Group.html)
...
### .[getControllerGrip](#getControllerGrip)( index : number ) : [Group](Group.html)
...
### .[getReferenceSpace](#getReferenceSpace)() : XRReferenceSpace

Returns the XR reference space.

**Returns:** The XR reference space.

### .[getReferenceSpaceType](#getReferenceSpaceType)() : XRReferenceSpaceType

Returns the reference space type.

**Returns:** The reference space type.

### .[getSession](#getSession)() : XRSession
...
### .[setFoveation](#setFoveation)( foveation : number )
...
### .[setFramebufferScaleFactor](#setFramebufferScaleFactor)( factor : number )
...
### .[setReferenceSpace](#setReferenceSpace)( space : XRReferenceSpace )
...
### .[setReferenceSpaceType](#setReferenceSpaceType)( type : XRReferenceSpaceType )
...
### .[setSession](#setSession)( session : XRSession ) : Promise (async)
...
### .[updateCamera](#updateCamera)( camera : [PerspectiveCamera](PerspectiveCamera.html) )
...
### .[useMultiview](#useMultiview)() : boolean
