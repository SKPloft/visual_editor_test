Title: ProjectorLight
Source URL: https://threejs.org/docs/pages/ProjectorLight.html
...
### new [ProjectorLight](#ProjectorLight)( color : number | [Color](Color.html) | string, intensity : number, distance : number, angle : number, penumbra : number, decay : number )
