Title: RectAreaLight
Source URL: https://threejs.org/docs/pages/RectAreaLight.html
...
### new [RectAreaLight](#RectAreaLight)( color : number | [Color](Color.html) | string, intensity : number, width : number, height : number )
...
### .[isRectAreaLight](#isRectAreaLight) : boolean (readonly)
