Title: SpotLight
Source URL: https://threejs.org/docs/pages/SpotLight.html
...
### new [SpotLight](#SpotLight)( color : number | [Color](Color.html) | string, intensity : number, distance : number, angle : number, penumbra : number, decay : number )
...
### .[isSpotLight](#isSpotLight) : boolean (readonly)
...
### .[shadow](#shadow) : [SpotLightShadow](SpotLightShadow.html)

This property holds the light's shadow configuration.

### .[target](#target) : [Object3D](Object3D.html)
