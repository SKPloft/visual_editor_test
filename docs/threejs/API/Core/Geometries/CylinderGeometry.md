...
Source URL: https://threejs.org/docs/pages/CylinderGeometry.html
...
### new [CylinderGeometry](#CylinderGeometry)( radiusTop : number, radiusBottom : number, height : number, radialSegments : number, heightSegments : number, openEnded : boolean, thetaStart : number, thetaLength : number )
...
### .[fromJSON](#.fromJSON)( data : Object ) : [CylinderGeometry](CylinderGeometry.html)
