Title: ConeGeometry
Source URL: https://threejs.org/docs/pages/ConeGeometry.html
...
### new [ConeGeometry](#ConeGeometry)( radius : number, height : number, radialSegments : number, heightSegments : number, openEnded : boolean, thetaStart : number, thetaLength : number )
...
### .[fromJSON](#.fromJSON)( data : Object ) : [ConeGeometry](ConeGeometry.html)
