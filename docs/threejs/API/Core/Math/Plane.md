Title: Plane
Source URL: https://threejs.org/docs/pages/Plane.html
...
### new [Plane](#Plane)( normal : [Vector3](Vector3.html), constant : number )
...
### .[isPlane](#isPlane) : boolean (readonly)

This flag can be used for type testing.

Default is `true`.

### .[normal](#normal) : [Vector3](Vector3.html)

A unit length vector defining the normal of the plane.

## Methods

### .[applyMatrix4](#applyMatrix4)( matrix : [Matrix4](Matrix4.html), optionalNormalMatrix : [Matrix4](Matrix4.html) ) : [Plane](Plane.html)
...
### .[clone](#clone)() : [Plane](Plane.html)

Returns a new plane with copied values from this instance.

**Returns:** A clone of this instance.

### .[coplanarPoint](#coplanarPoint)( target : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
...
### .[copy](#copy)( plane : [Plane](Plane.html) ) : [Plane](Plane.html)
...
### .[distanceToSphere](#distanceToSphere)( sphere : [Sphere](Sphere.html) ) : number
...
### .[equals](#equals)( plane : [Plane](Plane.html) ) : boolean
...
### .[intersectLine](#intersectLine)( line : [Line3](Line3.html), target : [Vector3](Vector3.html), clampToLine : boolean ) : [Vector3](Vector3.html)
...
### .[intersectsLine](#intersectsLine)( line : [Line3](Line3.html) ) : boolean
...
### .[negate](#negate)() : [Plane](Plane.html)

Negates both the plane normal and the constant.

**Returns:** A reference to this plane.

### .[normalize](#normalize)() : [Plane](Plane.html)

Normalizes the plane normal and adjusts the constant accordingly.

**Returns:** A reference to this plane.

### .[projectPoint](#projectPoint)( point : [Vector3](Vector3.html), target : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
...
### .[set](#set)( normal : [Vector3](Vector3.html), constant : number ) : [Plane](Plane.html)
...
### .[setComponents](#setComponents)( x : number, y : number, z : number, w : number ) : [Plane](Plane.html)
...
### .[setFromCoplanarPoints](#setFromCoplanarPoints)( a : [Vector3](Vector3.html), b : [Vector3](Vector3.html), c : [Vector3](Vector3.html) ) : [Plane](Plane.html)
...
### .[setFromNormalAndCoplanarPoint](#setFromNormalAndCoplanarPoint)( normal : [Vector3](Vector3.html), point : [Vector3](Vector3.html) ) : [Plane](Plane.html)
...
### .[translate](#translate)( offset : [Vector3](Vector3.html) ) : [Plane](Plane.html)
