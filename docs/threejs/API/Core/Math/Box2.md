Title: Box2
Source URL: https://threejs.org/docs/pages/Box2.html
...
### new [Box2](#Box2)( min : [Vector2](Vector2.html), max : [Vector2](Vector2.html) )
...
### .[isBox2](#isBox2) : boolean (readonly)

This flag can be used for type testing.

Default is `true`.

### .[max](#max) : [Vector2](Vector2.html)

The upper boundary of the box.

### .[min](#min) : [Vector2](Vector2.html)

The lower boundary of the box.

## Methods

### .[clampPoint](#clampPoint)( point : [Vector2](Vector2.html), target : [Vector2](Vector2.html) ) : [Vector2](Vector2.html)
...
### .[clone](#clone)() : [Box2](Box2.html)

Returns a new box with copied values from this instance.

**Returns:** A clone of this instance.

### .[containsBox](#containsBox)( box : [Box2](Box2.html) ) : boolean
...
### .[containsPoint](#containsPoint)( point : [Vector2](Vector2.html) ) : boolean
...
### .[copy](#copy)( box : [Box2](Box2.html) ) : [Box2](Box2.html)
...
### .[distanceToPoint](#distanceToPoint)( point : [Vector2](Vector2.html) ) : number
...
### .[equals](#equals)( box : [Box2](Box2.html) ) : boolean
...
### .[expandByPoint](#expandByPoint)( point : [Vector2](Vector2.html) ) : [Box2](Box2.html)
...
### .[expandByScalar](#expandByScalar)( scalar : number ) : [Box2](Box2.html)
...
### .[expandByVector](#expandByVector)( vector : [Vector2](Vector2.html) ) : [Box2](Box2.html)
...
### .[getCenter](#getCenter)( target : [Vector2](Vector2.html) ) : [Vector2](Vector2.html)
...
### .[getParameter](#getParameter)( point : [Vector2](Vector2.html), target : [Vector2](Vector2.html) ) : [Vector2](Vector2.html)
...
### .[intersect](#intersect)( box : [Box2](Box2.html) ) : [Box2](Box2.html)
...
### .[intersectsBox](#intersectsBox)( box : [Box2](Box2.html) ) : boolean
...
### .[makeEmpty](#makeEmpty)() : [Box2](Box2.html)

Makes this box empty which means in encloses a zero space in 2D.

**Returns:** A reference to this bounding box.

### .[set](#set)( min : [Vector2](Vector2.html), max : [Vector2](Vector2.html) ) : [Box2](Box2.html)
...
### .[setFromCenterAndSize](#setFromCenterAndSize)( center : [Vector2](Vector2.html), size : [Vector2](Vector2.html) ) : [Box2](Box2.html)
...
### .[setFromPoints](#setFromPoints)( points : Array.<[Vector2](Vector2.html)\> ) : [Box2](Box2.html)
...
### .[translate](#translate)( offset : [Vector2](Vector2.html) ) : [Box2](Box2.html)
...
### .[union](#union)( box : [Box2](Box2.html) ) : [Box2](Box2.html)
