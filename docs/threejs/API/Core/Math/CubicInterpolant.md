...
Source URL: https://threejs.org/docs/pages/CubicInterpolant.html
...
### new [CubicInterpolant](#CubicInterpolant)( parameterPositions : TypedArray, sampleValues : TypedArray, sampleSize : number, resultBuffer : TypedArray )
