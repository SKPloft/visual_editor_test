...
Source URL: https://threejs.org/docs/pages/QuaternionLinearInterpolant.html
...
### new [QuaternionLinearInterpolant](#QuaternionLinearInterpolant)( parameterPositions : TypedArray, sampleValues : TypedArray, sampleSize : number, resultBuffer : TypedArray )
