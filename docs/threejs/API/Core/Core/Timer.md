Title: Timer
Source URL: https://threejs.org/docs/pages/Timer.html
...
### .[connect](#connect)( document : Document )
...
### .[getElapsed](#getElapsed)() : number

Returns the elapsed time in seconds.

**Returns:** The elapsed time in second.

### .[getTimescale](#getTimescale)() : number

Returns the timescale.

**Returns:** The timescale.

### .[reset](#reset)() : [Timer](Timer.html)

Resets the time computation for the current simulation step.

**Returns:** A reference to this timer.

### .[setTimescale](#setTimescale)( timescale : number ) : [Timer](Timer.html)
...
### .[update](#update)( timestamp : number ) : [Timer](Timer.html)
