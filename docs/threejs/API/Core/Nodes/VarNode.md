Title: VarNode
Source URL: https://threejs.org/docs/pages/VarNode.html
...
### new [VarNode](#VarNode)( node : [Node](Node.html), name : string, readOnly : boolean )
...
### .[isVarNode](#isVarNode) : boolean (readonly)
...
### .[getIntent](#getIntent)() : boolean

Returns the intent flag of this node.

**Returns:** The intent flag.

### .[isIntent](#isIntent)( builder : [NodeBuilder](NodeBuilder.html) ) : boolean
...
### .[setIntent](#setIntent)( value : boolean ) : [VarNode](VarNode.html)
