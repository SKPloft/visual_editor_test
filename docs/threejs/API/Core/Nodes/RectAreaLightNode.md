...
Source URL: https://threejs.org/docs/pages/RectAreaLightNode.html
...
### new [RectAreaLightNode](#RectAreaLightNode)( light : [RectAreaLight](RectAreaLight.html) )
...
### .[halfHeight](#halfHeight) : [UniformNode](UniformNode.html).<vec3>

Uniform node representing the half height of the are light.

### .[halfWidth](#halfWidth) : [UniformNode](UniformNode.html).<vec3>
...
### .[setLTC](#.setLTC)( ltc : [RectAreaLightTexturesLib](RectAreaLightTexturesLib.html) )
