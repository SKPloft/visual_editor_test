...
Source URL: https://threejs.org/docs/pages/ColorSpaceNode.html
...
### new [ColorSpaceNode](#ColorSpaceNode)( colorNode : [Node](Node.html), source : string, target : string )
...
### .[resolveColorSpace](#resolveColorSpace)( builder : [NodeBuilder](NodeBuilder.html), colorSpace : string ) : string
