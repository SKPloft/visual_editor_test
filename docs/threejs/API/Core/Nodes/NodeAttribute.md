Title: NodeAttribute
Source URL: https://threejs.org/docs/pages/NodeAttribute.html
...
### new [NodeAttribute](#NodeAttribute)( name : string, type : string, node : [Node](Node.html) )
...
### .[isNodeAttribute](#isNodeAttribute) : boolean (readonly)
