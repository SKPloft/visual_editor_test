Title: VelocityNode
Source URL: https://threejs.org/docs/pages/VelocityNode.html
...
### new [VelocityNode](#VelocityNode)()

Constructs a new vertex color node.

## Properties

### .[previousCameraViewMatrix](#previousCameraViewMatrix) : [UniformNode](UniformNode.html).<mat4>

Uniform node representing the previous view matrix.

Default is `null`.

### .[previousModelWorldMatrix](#previousModelWorldMatrix) : [UniformNode](UniformNode.html).<mat4>

Uniform node representing the previous model matrix in world space.

Default is `null`.

### .[previousProjectionMatrix](#previousProjectionMatrix) : [UniformNode](UniformNode.html).<mat4>

Uniform node representing the previous projection matrix.

Default is `null`.

### .[projectionMatrix](#projectionMatrix) : [Matrix4](Matrix4.html)
...
### .[setProjectionMatrix](#setProjectionMatrix)( projectionMatrix : [Matrix4](Matrix4.html) )
...
### .[setup](#setup)( builder : [NodeBuilder](NodeBuilder.html) ) : [Node](Node.html).<vec2>
...
### .[updateAfter](#updateAfter)( frame : [NodeFrame](NodeFrame.html) )
