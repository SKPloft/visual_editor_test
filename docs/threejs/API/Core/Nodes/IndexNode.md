Title: IndexNode
Source URL: https://threejs.org/docs/pages/IndexNode.html
...
### new [IndexNode](#IndexNode)( scope : 'vertex' | 'instance' | 'subgroup' | 'invocationLocal' | 'invocationGlobal' | 'invocationSubgroup' | 'draw' )
...
### .[isIndexNode](#isIndexNode) : boolean (readonly)
