...
Source URL: https://threejs.org/docs/pages/MeshPhysicalNodeMaterial.html
...
### new [MeshPhysicalNodeMaterial](#MeshPhysicalNodeMaterial)( parameters : Object )
...
### .[anisotropyNode](#anisotropyNode) : [Node](Node.html).<float>
...
### .[attenuationColorNode](#attenuationColorNode) : [Node](Node.html).<vec3>
...
### .[attenuationDistanceNode](#attenuationDistanceNode) : [Node](Node.html).<float>
...
### .[clearcoatNode](#clearcoatNode) : [Node](Node.html).<float>
...
### .[clearcoatNormalNode](#clearcoatNormalNode) : [Node](Node.html).<vec3>
...
### .[clearcoatRoughnessNode](#clearcoatRoughnessNode) : [Node](Node.html).<float>
...
### .[dispersionNode](#dispersionNode) : [Node](Node.html).<float>
...
### .[iorNode](#iorNode) : [Node](Node.html).<float>
...
### .[iridescenceIORNode](#iridescenceIORNode) : [Node](Node.html).<float>
...
### .[iridescenceNode](#iridescenceNode) : [Node](Node.html).<float>
...
### .[iridescenceThicknessNode](#iridescenceThicknessNode) : [Node](Node.html).<float>
...
### .[isMeshPhysicalNodeMaterial](#isMeshPhysicalNodeMaterial) : boolean (readonly)

This flag can be used for type testing.

Default is `true`.

### .[sheenNode](#sheenNode) : [Node](Node.html).<vec3>
...
### .[sheenRoughnessNode](#sheenRoughnessNode) : [Node](Node.html).<float>
...
### .[specularColorNode](#specularColorNode) : [Node](Node.html).<vec3>
...
### .[specularIntensityNode](#specularIntensityNode) : [Node](Node.html).<float>
...
### .[thicknessNode](#thicknessNode) : [Node](Node.html).<float>
...
### .[transmissionNode](#transmissionNode) : [Node](Node.html).<float>
...
### .[useAnisotropy](#useAnisotropy) : boolean

Whether the lighting model should use anisotropy or not.

Default is `true`.

### .[useClearcoat](#useClearcoat) : boolean

Whether the lighting model should use clearcoat or not.

Default is `true`.

### .[useDispersion](#useDispersion) : boolean

Whether the lighting model should use dispersion or not.

Default is `true`.

### .[useIridescence](#useIridescence) : boolean

Whether the lighting model should use iridescence or not.

Default is `true`.

### .[useSheen](#useSheen) : boolean

Whether the lighting model should use sheen or not.

Default is `true`.

### .[useTransmission](#useTransmission) : boolean
...
### .[setupClearcoatNormal](#setupClearcoatNormal)() : [Node](Node.html).<vec3>

Setups the clearcoat normal node.

**Returns:** The clearcoat normal.

### .[setupLightingModel](#setupLightingModel)() : [PhysicalLightingModel](PhysicalLightingModel.html)
