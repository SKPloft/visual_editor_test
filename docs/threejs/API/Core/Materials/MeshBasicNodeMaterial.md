...
Source URL: https://threejs.org/docs/pages/MeshBasicNodeMaterial.html
...
### new [MeshBasicNodeMaterial](#MeshBasicNodeMaterial)( parameters : Object )
...
### .[isMeshBasicNodeMaterial](#isMeshBasicNodeMaterial) : boolean (readonly)
...
### .[setupEnvironment](#setupEnvironment)( builder : [NodeBuilder](NodeBuilder.html) ) : [BasicEnvironmentNode](BasicEnvironmentNode.html).<vec3>
...
### .[setupLightMap](#setupLightMap)( builder : [NodeBuilder](NodeBuilder.html) ) : [BasicLightMapNode](BasicLightMapNode.html).<vec3>
...
### .[setupLightingModel](#setupLightingModel)() : [BasicLightingModel](BasicLightingModel.html)
