Title: SSRNode
Source URL: https://threejs.org/docs/pages/SSRNode.html
...
### new [SSRNode](#SSRNode)( colorNode : [Node](Node.html).<vec4>, depthNode : [Node](Node.html).<float>, normalNode : [Node](Node.html).<vec3>, metalnessNode : [Node](Node.html).<float>, roughnessNode : [Node](Node.html).<float>, camera : [Camera](Camera.html) )
...
### .[blurQuality](#blurQuality) : [UniformNode](UniformNode.html).<int>
...
### .[colorNode](#colorNode) : [Node](Node.html).<vec4>
...
### .[maxDistance](#maxDistance) : [UniformNode](UniformNode.html).<float>
...
### .[opacity](#opacity) : [UniformNode](UniformNode.html).<float>

Controls how the SSR reflections are blended with the beauty pass.

### .[quality](#quality) : [UniformNode](UniformNode.html).<float>
