Title: DepthOfFieldNode
Source URL: https://threejs.org/docs/pages/DepthOfFieldNode.html
...
### new [DepthOfFieldNode](#DepthOfFieldNode)( textureNode : [TextureNode](TextureNode.html), viewZNode : [Node](Node.html).<float>, focusDistanceNode : [Node](Node.html).<float>, focalLengthNode : [Node](Node.html).<float>, bokehScaleNode : [Node](Node.html).<float> )
...
### .[bokehScaleNode](#bokehScaleNode) : [Node](Node.html).<float>

A unitless value for artistic purposes to adjust the size of the bokeh.

### .[focalLengthNode](#focalLengthNode) : [Node](Node.html).<float>

How far an object can be from the focal plane before it goes completely out-of-focus in world units.

### .[focusDistanceNode](#focusDistanceNode) : [Node](Node.html).<float>
...
### .[viewZNode](#viewZNode) : [Node](Node.html).<float>
