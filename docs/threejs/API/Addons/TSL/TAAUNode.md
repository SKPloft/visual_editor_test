Title: TAAUNode
Source URL: https://threejs.org/docs/pages/TAAUNode.html
...
### new [TAAUNode](#TAAUNode)( beautyNode : [TextureNode](TextureNode.html), depthNode : [TextureNode](TextureNode.html), velocityNode : [TextureNode](TextureNode.html), camera : [Camera](Camera.html) )
...
### .[currentFrameWeight](#currentFrameWeight) : number
...
### .[isTAAUNode](#isTAAUNode) : boolean (readonly)
...
### .[setSize](#setSize)( outputWidth : number, outputHeight : number )
...
### .[setViewOffset](#setViewOffset)( inputWidth : number, inputHeight : number )
