Title: AfterImageNode
Source URL: https://threejs.org/docs/pages/AfterImageNode.html
...
### new [AfterImageNode](#AfterImageNode)( textureNode : [TextureNode](TextureNode.html), damp : [Node](Node.html).<float> )
...
### .[damp](#damp) : [Node](Node.html).<float>
