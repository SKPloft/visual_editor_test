Title: KTXLoader
Source URL: https://threejs.org/docs/pages/KTXLoader.html
...
### new [KTXLoader](#KTXLoader)( manager : [LoadingManager](LoadingManager.html) )
...
### .[parse](#parse)( buffer : ArrayBuffer, loadMipmaps : boolean ) : [CompressedTextureLoader~TexData](CompressedTextureLoader.html#~TexData)
