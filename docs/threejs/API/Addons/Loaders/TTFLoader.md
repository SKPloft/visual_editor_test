Title: TTFLoader
Source URL: https://threejs.org/docs/pages/TTFLoader.html
...
### new [TTFLoader](#TTFLoader)( manager : [LoadingManager](LoadingManager.html) )
...
### .[parse](#parse)( arraybuffer : ArrayBuffer ) : Object
