Title: FBXLoader
Source URL: https://threejs.org/docs/pages/FBXLoader.html
...
### new [FBXLoader](#FBXLoader)( manager : [LoadingManager](LoadingManager.html) )
...
### .[parse](#parse)( FBXBuffer : ArrayBuffer, path : string ) : [Group](Group.html)
