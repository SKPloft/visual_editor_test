Title: CSMHelper
Source URL: https://threejs.org/docs/pages/CSMHelper.html
...
### new [CSMHelper](#CSMHelper)( csm : [CSM](CSM.html) | [CSMShadowNode](CSMShadowNode.html) )
...
### .[csm](#csm) : [CSM](CSM.html) | [CSMShadowNode](CSMShadowNode.html)

The CSM instance to visualize.

### .[displayFrustum](#displayFrustum) : boolean

Whether to display the CSM frustum or not.

Default is `true`.

### .[displayPlanes](#displayPlanes) : boolean

Whether to display the cascade planes or not.

Default is `true`.

### .[displayShadowBounds](#displayShadowBounds) : boolean
