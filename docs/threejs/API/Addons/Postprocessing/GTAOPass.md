Title: GTAOPass
Source URL: https://threejs.org/docs/pages/GTAOPass.html
...
### new [GTAOPass](#GTAOPass)( scene : [Scene](Scene.html), camera : [Camera](Camera.html), width : number, height : number, parameters : Object, aoParameters : Object, pdParameters : Object )
...
### .[blendIntensity](#blendIntensity) : number
...
### .[gtaoMap](#gtaoMap) : [Texture](Texture.html) (readonly)
...
### .[pdRadiusExponent](#pdRadiusExponent) : number

The Poisson Denoise radius exponent.

Default is `2`.

### .[pdRings](#pdRings) : number

The number of Poisson Denoise rings.

Default is `2`.

### .[pdSamples](#pdSamples) : number
...
### .[setGBuffer](#setGBuffer)( depthTexture : [DepthTexture](DepthTexture.html), normalTexture : [DepthTexture](DepthTexture.html) )
...
### .[setSceneClipBox](#setSceneClipBox)( box : [Box3](Box3.html) )
...
### .[updateGtaoMaterial](#updateGtaoMaterial)( parameters : Object )
...
### .[updatePdMaterial](#updatePdMaterial)( parameters : Object )
