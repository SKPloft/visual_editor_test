Title: BloomPass
Source URL: https://threejs.org/docs/pages/BloomPass.html
...
### new [BloomPass](#BloomPass)( strength : number, kernelSize : number, sigma : number )
...
### .[combineUniforms](#combineUniforms) : Object

The combine pass uniforms.

### .[convolutionUniforms](#convolutionUniforms) : Object

The convolution pass uniforms.

### .[materialCombine](#materialCombine) : [ShaderMaterial](ShaderMaterial.html)

The combine pass material.

### .[materialConvolution](#materialConvolution) : [ShaderMaterial](ShaderMaterial.html)
