Title: BokehPass
Source URL: https://threejs.org/docs/pages/BokehPass.html
...
### new [BokehPass](#BokehPass)( scene : [Scene](Scene.html), camera : [Camera](Camera.html), params : [BokehPass~Options](BokehPass.html#~Options) )
...
### .[materialBokeh](#materialBokeh) : [ShaderMaterial](ShaderMaterial.html)
