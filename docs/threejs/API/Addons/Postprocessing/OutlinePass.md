Title: OutlinePass
Source URL: https://threejs.org/docs/pages/OutlinePass.html
...
### new [OutlinePass](#OutlinePass)( resolution : [Vector2](Vector2.html), scene : [Scene](Scene.html), camera : [Camera](Camera.html), selectedObjects : Array.<[Object3D](Object3D.html)\> )
...
### .[downSampleRatio](#downSampleRatio) : number

The downsample ratio. The effect can be rendered in a much lower resolution than the beauty pass.

Default is `2`.

### .[edgeGlow](#edgeGlow) : number

Can be used for an animated glow/pulse effect.

Default is `0`.

### .[edgeStrength](#edgeStrength) : number

The edge strength.

Default is `3`.

### .[edgeThickness](#edgeThickness) : number

The edge thickness.

Default is `1`.

### .[hiddenEdgeColor](#hiddenEdgeColor) : [Color](Color.html)

The hidden edge color.

Default is `(0.1,0.04,0.02)`.

### .[patternTexture](#patternTexture) : [Texture](Texture.html)
...
### .[pulsePeriod](#pulsePeriod) : number

The pulse period.

Default is `0`.

### .[renderCamera](#renderCamera) : Object

The camera.

### .[renderScene](#renderScene) : Object
...
### .[selectedObjects](#selectedObjects) : Array.<[Object3D](Object3D.html)\>

The selected 3D objects that should receive an outline.

### .[usePatternTexture](#usePatternTexture) : boolean

Whether to use a pattern texture for to highlight selected 3D objects or not.

Default is `false`.

### .[visibleEdgeColor](#visibleEdgeColor) : [Color](Color.html)
