...
Source URL: https://threejs.org/docs/pages/ParallaxBarrierEffect.html
...
### new [ParallaxBarrierEffect](#ParallaxBarrierEffect)( renderer : [WebGLRenderer](WebGLRenderer.html) )
