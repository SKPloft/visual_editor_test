Title: module-BufferGeometryUtils
Source URL: https://threejs.org/docs/pages/module-BufferGeometryUtils.html
...
### .[computeMikkTSpaceTangents](#~computeMikkTSpaceTangents)( geometry : [BufferGeometry](BufferGeometry.html), MikkTSpace : Object, negateSign : boolean ) : [BufferGeometry](BufferGeometry.html) (inner)
...
### .[computeMorphedAttributes](#~computeMorphedAttributes)( object : [Mesh](Mesh.html) | [Line](Line.html) | [Points](Points.html) ) : Object (inner)
...
### .[deepCloneAttribute](#~deepCloneAttribute)( attribute : [BufferAttribute](BufferAttribute.html) ) : [BufferAttribute](BufferAttribute.html) (inner)
...
### .[deinterleaveAttribute](#~deinterleaveAttribute)( attribute : [InterleavedBufferAttribute](InterleavedBufferAttribute.html) ) : [BufferAttribute](BufferAttribute.html) (inner)
...
### .[deinterleaveGeometry](#~deinterleaveGeometry)( geometry : [BufferGeometry](BufferGeometry.html) ) (inner)
...
### .[estimateBytesUsed](#~estimateBytesUsed)( geometry : [BufferGeometry](BufferGeometry.html) ) : number (inner)
...
### .[interleaveAttributes](#~interleaveAttributes)( attributes : Array.<[BufferAttribute](BufferAttribute.html)\> ) : Array.<[InterleavedBufferAttribute](InterleavedBufferAttribute.html)\> (inner)
...
### .[mergeAttributes](#~mergeAttributes)( attributes : Array.<[BufferAttribute](BufferAttribute.html)\> ) : [BufferAttribute](BufferAttribute.html) (inner)
...
### .[mergeGeometries](#~mergeGeometries)( geometries : Array.<[BufferGeometry](BufferGeometry.html)\>, useGroups : boolean ) : [BufferGeometry](BufferGeometry.html) (inner)
...
### .[mergeGroups](#~mergeGroups)( geometry : [BufferGeometry](BufferGeometry.html) ) : [BufferGeometry](BufferGeometry.html) (inner)
...
### .[mergeVertices](#~mergeVertices)( geometry : [BufferGeometry](BufferGeometry.html), tolerance : number ) : [BufferGeometry](BufferGeometry.html) (inner)
...
### .[toCreasedNormals](#~toCreasedNormals)( geometry : [BufferGeometry](BufferGeometry.html), creaseAngle : number ) : [BufferGeometry](BufferGeometry.html) (inner)
...
### .[toTrianglesDrawMode](#~toTrianglesDrawMode)( geometry : [BufferGeometry](BufferGeometry.html), drawMode : number ) : [BufferGeometry](BufferGeometry.html) (inner)
