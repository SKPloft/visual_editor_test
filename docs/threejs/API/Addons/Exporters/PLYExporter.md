Title: PLYExporter
Source URL: https://threejs.org/docs/pages/PLYExporter.html
...
### .[parse](#parse)( object : [Object3D](Object3D.html), onDone : [PLYExporter~OnDone](PLYExporter.html#~OnDone), options : [PLYExporter~Options](PLYExporter.html#~Options) ) : string | ArrayBuffer
...
### .[OnDone](#~OnDone)( result : string | ArrayBuffer )
