Title: DRACOExporter
Source URL: https://threejs.org/docs/pages/DRACOExporter.html
...
### .[MESH\_EDGEBREAKER\_ENCODING](#.MESH_EDGEBREAKER_ENCODING) : number (constant)

Edgebreaker encoding.

Default is `1`.

### .[MESH\_SEQUENTIAL\_ENCODING](#.MESH_SEQUENTIAL_ENCODING) : number (constant)
...
### .[parse](#parse)( object : [Mesh](Mesh.html) | [Points](Points.html), options : [DRACOExporter~Options](DRACOExporter.html#~Options) ) : Int8Array
