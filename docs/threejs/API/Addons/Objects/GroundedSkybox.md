...
Source URL: https://threejs.org/docs/pages/GroundedSkybox.html
...
### new [GroundedSkybox](#GroundedSkybox)( map : [Texture](Texture.html), height : number, radius : number, resolution : number )
