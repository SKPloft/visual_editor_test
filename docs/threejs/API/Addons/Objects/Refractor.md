Title: Refractor
Source URL: https://threejs.org/docs/pages/Refractor.html
...
### new [Refractor](#Refractor)( geometry : [BufferGeometry](BufferGeometry.html), options : [Refractor~Options](Refractor.html#~Options) )
...
### .[isRefractor](#isRefractor) : boolean (readonly)
