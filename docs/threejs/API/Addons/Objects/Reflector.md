Title: Reflector
Source URL: https://threejs.org/docs/pages/Reflector.html
...
### new [Reflector](#Reflector)( geometry : [BufferGeometry](BufferGeometry.html), options : [Reflector~Options](Reflector.html#~Options) )
...
### .[isReflector](#isReflector) : boolean (readonly)
