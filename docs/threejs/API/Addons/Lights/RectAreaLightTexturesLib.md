...
Source URL: https://threejs.org/docs/pages/RectAreaLightTexturesLib.html
...
### .[LTC\_FLOAT\_1](#.LTC_FLOAT_1) : [DataTexture](DataTexture.html)

The first LTC FP32 data texture.

Default is `null`.

### .[LTC\_FLOAT\_2](#.LTC_FLOAT_2) : [DataTexture](DataTexture.html)

The second LTC FP32 data texture.

Default is `null`.

### .[LTC\_HALF\_1](#.LTC_HALF_1) : [DataTexture](DataTexture.html)

The first LTC FP16 data texture.

Default is `null`.

### .[LTC\_HALF\_2](#.LTC_HALF_2) : [DataTexture](DataTexture.html)
...
### .[init](#.init)() : [RectAreaLightTexturesLib](RectAreaLightTexturesLib.html)
