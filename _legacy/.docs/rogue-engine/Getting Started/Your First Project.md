Title: GettingStarted/YourFirstProject
Source URL: https://docs.rogueengine.io/GettingStarted/YourFirstProject
...
If you navigate to the project folder you'll see that a few files and folders have been created. These are part of the [Node.js (opens new window)](https://nodejs.org/) environment of the project and you shouldn't mess with them unless you really know what you're doing.
