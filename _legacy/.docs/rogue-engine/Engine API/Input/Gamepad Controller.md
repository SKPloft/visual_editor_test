Title: EngineAPI/Input/GamepadController
Source URL: https://docs.rogueengine.io/EngineAPI/Input/GamepadController
...
This is just an abstraction of the [Gamepad (opens new window)](https://developer.mozilla.org/en-US/docs/Web/API/Gamepad) API. To learn about the mapping of all the buttons of a controller visit [gamepad-tester.com (opens new window)](https://gamepad-tester.com/)
...
This property holds the [Gamepad (opens new window)](https://developer.mozilla.org/en-US/docs/Web/API/Gamepad) object associated to this `GamepadController`.
...
To learn about the mapping of all the buttons for the Gamepad API visit [gamepad-tester.com (opens new window)](https://gamepad-tester.com/)
...
To learn about the mapping of all the buttons of a controller visit [gamepad-tester.com (opens new window)](https://gamepad-tester.com/)
