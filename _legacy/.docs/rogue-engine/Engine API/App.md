Title: EngineAPI/App
Source URL: https://docs.rogueengine.io/EngineAPI/App
...
This method clones a given [Object3D (opens new window)](https://threejs.org/docs/#api/en/core/Object3D) with all its components. It's basically Rogue Engine's version of **Object3D.clone** which only clones the object.