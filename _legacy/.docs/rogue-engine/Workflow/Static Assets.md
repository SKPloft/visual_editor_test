Title: Workflow/StaticAssets
Source URL: https://docs.rogueengine.io/Workflow/StaticAssets
...
The first and most important thing is that you store your static assets in _ProjectFolder/Static/_. This folder will be accessible both in development and in your built project.
...
If you have any static files, your built project will include the _/Static/_ folder with all its contents.