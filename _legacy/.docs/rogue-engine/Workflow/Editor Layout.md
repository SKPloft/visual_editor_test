Title: Workflow/EditorLayout
Source URL: https://docs.rogueengine.io/Workflow/EditorLayout
...
At the left of the toolbar you'll find the transform controls. These allow us set the type of control we wish to use to mutate the transform properties of an [Object3D (opens new window)](https://threejs.org/docs/#api/en/core/Object3D) present in the current [Scene](/assets/Scenes).
...
The Skybox Window lets set and modify our Scene's skybox. You have two different modes to select: procedural and cubemap. If you feel this feature is hurting the performance of your app or, it's simply irrelevant, you can disable it by unchecking the **enabled** box.
