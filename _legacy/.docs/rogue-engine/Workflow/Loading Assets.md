Title: Workflow/LoadingAssets
Source URL: https://docs.rogueengine.io/Workflow/LoadingAssets
...
Another way to load assets is to treat them as static files. To do this you just have to put them inside _ProjectFolder/Static_. This route will be available from your built project as well so, go nuts... but not too much eh! Remember the loading times and all that. Fetch them wisely.
