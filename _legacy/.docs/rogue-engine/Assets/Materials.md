...
Source URL: https://docs.rogueengine.io/assets/Materials

###  Materials

Materials are essential for making things look good. They are used by [Meshes (opens new window)](https://threejs.org/docs/#api/en/objects/Mesh) to provide texture and other graphic sugar.
...
The **.rogueMaterial** file contains the serialization of a Three.js [Material (opens new window)](https://threejs.org/docs/#api/en/materials/Material) and it can be used by any number of meshes in the same project.
...
To create a Material, right click on the target folder and select _Assets -> \[TypeOfMaterial\]_

Alternatively you can select the target folder and click on _Assets -> \[TypeOfMaterial\]_ on the top menu.
