...
Source URL: https://threejs.org/docs/pages/HemisphereLightHelper.html
...
### new [HemisphereLightHelper](#HemisphereLightHelper)( light : [HemisphereLight](HemisphereLight.html), size : number, color : number | [Color](Color.html) | string )
...
### .[light](#light) : [HemisphereLight](HemisphereLight.html)
