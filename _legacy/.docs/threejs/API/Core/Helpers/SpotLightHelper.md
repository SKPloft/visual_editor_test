...
Source URL: https://threejs.org/docs/pages/SpotLightHelper.html
...
### new [SpotLightHelper](#SpotLightHelper)( light : [HemisphereLight](HemisphereLight.html), color : number | [Color](Color.html) | string )
...
### .[light](#light) : [SpotLight](SpotLight.html)
