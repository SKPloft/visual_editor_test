...
Source URL: https://threejs.org/docs/pages/OrthographicCamera.html
...
### new [OrthographicCamera](#OrthographicCamera)( left : number, right : number, top : number, bottom : number, near : number, far : number )
...
### .[isOrthographicCamera](#isOrthographicCamera) : boolean (readonly)
