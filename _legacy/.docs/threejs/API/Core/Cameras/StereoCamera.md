Title: StereoCamera
Source URL: https://threejs.org/docs/pages/StereoCamera.html
...
### .[cameraL](#cameraL) : [PerspectiveCamera](PerspectiveCamera.html)
...
### .[cameraR](#cameraR) : [PerspectiveCamera](PerspectiveCamera.html)
...
### .[update](#update)( camera : [PerspectiveCamera](PerspectiveCamera.html) )
