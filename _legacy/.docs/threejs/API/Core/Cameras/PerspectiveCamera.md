...
Source URL: https://threejs.org/docs/pages/PerspectiveCamera.html
...
### new [PerspectiveCamera](#PerspectiveCamera)( fov : number, aspect : number, near : number, far : number )
...
### .[isPerspectiveCamera](#isPerspectiveCamera) : boolean (readonly)
...
### .[getEffectiveFOV](#getEffectiveFOV)() : number
...
### .[getFilmHeight](#getFilmHeight)() : number
...
### .[getFilmWidth](#getFilmWidth)() : number
...
### .[getFocalLength](#getFocalLength)() : number
...
### .[getViewBounds](#getViewBounds)( distance : number, minTarget : [Vector2](Vector2.html), maxTarget : [Vector2](Vector2.html) )
...
### .[getViewSize](#getViewSize)( distance : number, target : [Vector2](Vector2.html) ) : [Vector2](Vector2.html)
...
### .[setFocalLength](#setFocalLength)( focalLength : number )
...
### .[setViewOffset](#setViewOffset)( fullWidth : number, fullHeight : number, x : number, y : number, width : number, height : number )
