Title: module-Interpolations
Source URL: https://threejs.org/docs/pages/module-Interpolations.html
...
### .[CatmullRom](#~CatmullRom)( t : number, p0 : number, p1 : number, p2 : number, p3 : number ) : number (inner)
...
### .[CubicBezier](#~CubicBezier)( t : number, p0 : number, p1 : number, p2 : number, p3 : number ) : number (inner)
...
### .[QuadraticBezier](#~QuadraticBezier)( t : number, p0 : number, p1 : number, p2 : number ) : number (inner)
