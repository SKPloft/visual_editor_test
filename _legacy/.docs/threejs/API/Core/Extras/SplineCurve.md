Title: SplineCurve
Source URL: https://threejs.org/docs/pages/SplineCurve.html
...
### new [SplineCurve](#SplineCurve)( points : Array.<[Vector2](Vector2.html)\> )
...
### .[isSplineCurve](#isSplineCurve) : boolean (readonly)

This flag can be used for type testing.

Default is `true`.

### .[points](#points) : Array.<[Vector2](Vector2.html)\>
