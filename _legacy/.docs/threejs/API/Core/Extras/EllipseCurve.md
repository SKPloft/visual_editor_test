Title: EllipseCurve
Source URL: https://threejs.org/docs/pages/EllipseCurve.html
...
### new [EllipseCurve](#EllipseCurve)( aX : number, aY : number, xRadius : number, yRadius : number, aStartAngle : number, aEndAngle : number, aClockwise : boolean, aRotation : number )
...
### .[aClockwise](#aClockwise) : boolean

Whether the ellipse is drawn clockwise or not.

Default is `false`.

### .[aEndAngle](#aEndAngle) : number

The end angle of the curve in radians starting from the positive X axis.

Default is `Math.PI*2`.

### .[aRotation](#aRotation) : number

The rotation angle of the ellipse in radians, counterclockwise from the positive X axis.

Default is `0`.

### .[aStartAngle](#aStartAngle) : number
...
### .[isEllipseCurve](#isEllipseCurve) : boolean (readonly)

This flag can be used for type testing.

Default is `true`.

### .[xRadius](#xRadius) : number
