...
Source URL: https://threejs.org/docs/pages/ViewportTextureNode.html
...
### new [ViewportTextureNode](#ViewportTextureNode)( uvNode : [Node](Node.html), levelNode : [Node](Node.html), framebufferTexture : [Texture](Texture.html) )
...
### .[defaultFramebuffer](#defaultFramebuffer) : [FramebufferTexture](FramebufferTexture.html)
...
### .[isOutputTextureNode](#isOutputTextureNode) : boolean (readonly)
...
### .[getTextureForReference](#getTextureForReference)( reference : [RenderTarget](RenderTarget.html) | [CanvasTarget](CanvasTarget.html) ) : [Texture](Texture.html)
