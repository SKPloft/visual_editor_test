...
Source URL: https://threejs.org/docs/pages/StructTypeNode.html
...
### new [StructTypeNode](#StructTypeNode)( membersLayout : Object, name : string )
...
### .[isStructLayoutNode](#isStructLayoutNode) : boolean (readonly)

This flag can be used for type testing.

Default is `true`.

### .[membersLayout](#membersLayout) : Array.<{name: string, type: string, atomic: boolean}>
