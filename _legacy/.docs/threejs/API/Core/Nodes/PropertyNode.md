Title: PropertyNode
Source URL: https://threejs.org/docs/pages/PropertyNode.html
...
### new [PropertyNode](#PropertyNode)( nodeType : string, name : string, varying : boolean )
...
### .[isPropertyNode](#isPropertyNode) : boolean (readonly)
