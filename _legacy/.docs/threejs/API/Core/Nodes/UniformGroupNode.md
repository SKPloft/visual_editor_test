...
Source URL: https://threejs.org/docs/pages/UniformGroupNode.html
...
### new [UniformGroupNode](#UniformGroupNode)( name : string, shared : boolean, order : number, updateType : string | null )
...
### .[isUniformGroup](#isUniformGroup) : boolean (readonly)
...
### .[updateType](#updateType) : string | null
...
### .[deserialize](#deserialize)( data : Object )
...
### .[serialize](#serialize)( data : Object )
