Title: StackTrace
Source URL: https://threejs.org/docs/pages/StackTrace.html
...
### new [StackTrace](#StackTrace)( stackMessage : Error | string | null )
...
### .[isStackTrace](#isStackTrace) : boolean (readonly)

This flag can be used for type testing.

Default is `true`.

### .[stack](#stack) : Array.<{fn: string, file: string, line: number, column: number}>

The stack trace.

## Methods

### .[getError](#getError)( message : string ) : string
...
### .[getLocation](#getLocation)() : string
