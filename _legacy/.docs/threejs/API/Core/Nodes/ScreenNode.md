Title: ScreenNode
Source URL: https://threejs.org/docs/pages/ScreenNode.html
...
### new [ScreenNode](#ScreenNode)( scope : 'coordinate' | 'viewport' | 'size' | 'uv' | 'dpr' )
...
### .[isViewportNode](#isViewportNode) : boolean (readonly)

This flag can be used for type testing.

Default is `true`.

### .[scope](#scope) : 'coordinate' | 'viewport' | 'size' | 'uv' | 'dpr'
...
### .[generateNodeType](#generateNodeType)() : 'float' | 'vec2' | 'vec4'
