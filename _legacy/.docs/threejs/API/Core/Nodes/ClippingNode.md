Title: ClippingNode
Source URL: https://threejs.org/docs/pages/ClippingNode.html
...
### new [ClippingNode](#ClippingNode)( scope : 'default' | 'hardware' | 'alphaToCoverage' )
...
### .[scope](#scope) : 'default' | 'hardware' | 'alphaToCoverage'
...
### .[setupAlphaToCoverage](#setupAlphaToCoverage)( intersectionPlanes : Array.<[Vector4](Vector4.html)\>, unionPlanes : Array.<[Vector4](Vector4.html)\> ) : [Node](Node.html)
...
### .[setupDefault](#setupDefault)( intersectionPlanes : Array.<[Vector4](Vector4.html)\>, unionPlanes : Array.<[Vector4](Vector4.html)\> ) : [Node](Node.html)
...
### .[setupHardwareClipping](#setupHardwareClipping)( unionPlanes : Array.<[Vector4](Vector4.html)\>, builder : [NodeBuilder](NodeBuilder.html) ) : [Node](Node.html)
