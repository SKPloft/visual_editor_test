Title: NodeVar
Source URL: https://threejs.org/docs/pages/NodeVar.html
...
### new [NodeVar](#NodeVar)( name : string, type : string, readOnly : boolean, count : number )
...
### .[isNodeVar](#isNodeVar) : boolean (readonly)
