Title: Euler
Source URL: https://threejs.org/docs/pages/Euler.html
...
### new [Euler](#Euler)( x : number, y : number, z : number, order : string )
...
### .[isEuler](#isEuler) : boolean (readonly)
...
### .[DEFAULT\_ORDER](#.DEFAULT_ORDER) : string
...
### .[clone](#clone)() : [Euler](Euler.html)

Returns a new Euler instance with copied values from this instance.

**Returns:** A clone of this instance.

### .[copy](#copy)( euler : [Euler](Euler.html) ) : [Euler](Euler.html)
...
### .[equals](#equals)( euler : [Euler](Euler.html) ) : boolean
...
### .[fromArray](#fromArray)( array : Array.<number, number, number, ?string> ) : [Euler](Euler.html)
...
### .[reorder](#reorder)( newOrder : string ) : [Euler](Euler.html)
...
### .[set](#set)( x : number, y : number, z : number, order : string ) : [Euler](Euler.html)
...
### .[setFromQuaternion](#setFromQuaternion)( q : [Quaternion](Quaternion.html), order : string, update : boolean ) : [Euler](Euler.html)
...
### .[setFromRotationMatrix](#setFromRotationMatrix)( m : [Matrix4](Matrix4.html), order : string, update : boolean ) : [Euler](Euler.html)
...
### .[setFromVector3](#setFromVector3)( v : [Vector3](Vector3.html), order : string ) : [Euler](Euler.html)
...
### .[toArray](#toArray)( array : Array.<number, number, number, string>, offset : number ) : Array.<number, number, number, string>
