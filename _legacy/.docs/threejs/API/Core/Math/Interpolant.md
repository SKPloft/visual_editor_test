Title: Interpolant
Source URL: https://threejs.org/docs/pages/Interpolant.html
...
### new [Interpolant](#Interpolant)( parameterPositions : TypedArray, sampleValues : TypedArray, sampleSize : number, resultBuffer : TypedArray ) (abstract)
...
### .[DefaultSettings\_](#DefaultSettings_) : Object

The default settings object.

### .[parameterPositions](#parameterPositions) : TypedArray

The parameter positions.

### .[resultBuffer](#resultBuffer) : TypedArray

The result buffer.

### .[sampleValues](#sampleValues) : TypedArray
...
### .[valueSize](#valueSize) : TypedArray

The value size.

## Methods

### .[copySampleValue\_](#copySampleValue_)( index : number ) : TypedArray
...
### .[evaluate](#evaluate)( t : number ) : TypedArray
...
### .[getSettings\_](#getSettings_)() : Object

Returns the interpolation settings.

**Returns:** The interpolation settings.

### .[interpolate\_](#interpolate_)( i1 : number, t0 : number, t : number, t1 : number ) : TypedArray (abstract)
...
### .[intervalChanged\_](#intervalChanged_)( i1 : number, t0 : number, t : number )
