Title: Quaternion
Source URL: https://threejs.org/docs/pages/Quaternion.html
...
### new [Quaternion](#Quaternion)( x : number, y : number, z : number, w : number )
...
### .[isQuaternion](#isQuaternion) : boolean (readonly)
...
### .[angleTo](#angleTo)( q : [Quaternion](Quaternion.html) ) : number
...
### .[clone](#clone)() : [Quaternion](Quaternion.html)

Returns a new quaternion with copied values from this instance.

**Returns:** A clone of this instance.

### .[conjugate](#conjugate)() : [Quaternion](Quaternion.html)

Returns the rotational conjugate of this quaternion. The conjugate of a quaternion represents the same rotation in the opposite direction about the rotational axis.

**Returns:** A reference to this quaternion.

### .[copy](#copy)( quaternion : [Quaternion](Quaternion.html) ) : [Quaternion](Quaternion.html)
...
### .[dot](#dot)( v : [Quaternion](Quaternion.html) ) : number
...
### .[equals](#equals)( quaternion : [Quaternion](Quaternion.html) ) : boolean
...
### .[fromArray](#fromArray)( array : Array.<number>, offset : number ) : [Quaternion](Quaternion.html)
...
### .[fromBufferAttribute](#fromBufferAttribute)( attribute : [BufferAttribute](BufferAttribute.html), index : number ) : [Quaternion](Quaternion.html)
...
### .[multiply](#multiply)( q : [Quaternion](Quaternion.html) ) : [Quaternion](Quaternion.html)
...
### .[multiplyQuaternions](#multiplyQuaternions)( a : [Quaternion](Quaternion.html), b : [Quaternion](Quaternion.html) ) : [Quaternion](Quaternion.html)
...
### .[normalize](#normalize)() : [Quaternion](Quaternion.html)
...
### .[premultiply](#premultiply)( q : [Quaternion](Quaternion.html) ) : [Quaternion](Quaternion.html)
...
### .[random](#random)() : [Quaternion](Quaternion.html)

Sets this quaternion to a uniformly random, normalized quaternion.

**Returns:** A reference to this quaternion.

### .[rotateTowards](#rotateTowards)( q : [Quaternion](Quaternion.html), step : number ) : [Quaternion](Quaternion.html)
...
### .[set](#set)( x : number, y : number, z : number, w : number ) : [Quaternion](Quaternion.html)
...
### .[setFromAxisAngle](#setFromAxisAngle)( axis : [Vector3](Vector3.html), angle : number ) : [Quaternion](Quaternion.html)
...
### .[setFromEuler](#setFromEuler)( euler : [Euler](Euler.html), update : boolean ) : [Quaternion](Quaternion.html)
...
### .[setFromRotationMatrix](#setFromRotationMatrix)( m : [Matrix4](Matrix4.html) ) : [Quaternion](Quaternion.html)
...
### .[setFromUnitVectors](#setFromUnitVectors)( vFrom : [Vector3](Vector3.html), vTo : [Vector3](Vector3.html) ) : [Quaternion](Quaternion.html)
...
### .[slerp](#slerp)( qb : [Quaternion](Quaternion.html), t : number ) : [Quaternion](Quaternion.html)
...
### .[slerpQuaternions](#slerpQuaternions)( qa : [Quaternion](Quaternion.html), qb : [Quaternion](Quaternion.html), t : number ) : [Quaternion](Quaternion.html)
...
### .[multiplyQuaternionsFlat](#.multiplyQuaternionsFlat)( dst : Array.<number>, dstOffset : number, src0 : Array.<number>, srcOffset0 : number, src1 : Array.<number>, srcOffset1 : number ) : Array.<number>
...
### .[slerpFlat](#.slerpFlat)( dst : Array.<number>, dstOffset : number, src0 : Array.<number>, srcOffset0 : number, src1 : Array.<number>, srcOffset1 : number, t : number )
