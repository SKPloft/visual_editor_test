...
Source URL: https://threejs.org/docs/pages/DiscreteInterpolant.html
...
### new [DiscreteInterpolant](#DiscreteInterpolant)( parameterPositions : TypedArray, sampleValues : TypedArray, sampleSize : number, resultBuffer : TypedArray )
