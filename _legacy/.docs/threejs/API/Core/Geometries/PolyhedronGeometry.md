...
Source URL: https://threejs.org/docs/pages/PolyhedronGeometry.html
...
### new [PolyhedronGeometry](#PolyhedronGeometry)( vertices : Array.<number>, indices : Array.<number>, radius : number, detail : number )
...
### .[fromJSON](#.fromJSON)( data : Object ) : [PolyhedronGeometry](PolyhedronGeometry.html)
