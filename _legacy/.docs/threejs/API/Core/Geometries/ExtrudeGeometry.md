...
Source URL: https://threejs.org/docs/pages/ExtrudeGeometry.html
...
### new [ExtrudeGeometry](#ExtrudeGeometry)( shapes : [Shape](Shape.html) | Array.<[Shape](Shape.html)\>, options : [ExtrudeGeometry~Options](ExtrudeGeometry.html#~Options) )
...
### .[fromJSON](#.fromJSON)( data : Object, shapes : Array.<[Shape](Shape.html)\> ) : [ExtrudeGeometry](ExtrudeGeometry.html)
