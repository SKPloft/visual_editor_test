Title: RingGeometry
Source URL: https://threejs.org/docs/pages/RingGeometry.html
...
### new [RingGeometry](#RingGeometry)( innerRadius : number, outerRadius : number, thetaSegments : number, phiSegments : number, thetaStart : number, thetaLength : number )
...
### .[fromJSON](#.fromJSON)( data : Object ) : [RingGeometry](RingGeometry.html)
