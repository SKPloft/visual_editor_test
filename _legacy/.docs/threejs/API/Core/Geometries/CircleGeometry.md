...
Source URL: https://threejs.org/docs/pages/CircleGeometry.html
...
### new [CircleGeometry](#CircleGeometry)( radius : number, segments : number, thetaStart : number, thetaLength : number )
...
### .[fromJSON](#.fromJSON)( data : Object ) : [CircleGeometry](CircleGeometry.html)
