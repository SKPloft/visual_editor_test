Title: BoxGeometry
Source URL: https://threejs.org/docs/pages/BoxGeometry.html
...
### new [BoxGeometry](#BoxGeometry)( width : number, height : number, depth : number, widthSegments : number, heightSegments : number, depthSegments : number )
...
### .[fromJSON](#.fromJSON)( data : Object ) : [BoxGeometry](BoxGeometry.html)
