...
Source URL: https://threejs.org/docs/pages/TorusKnotGeometry.html
...
### new [TorusKnotGeometry](#TorusKnotGeometry)( radius : number, tube : number, tubularSegments : number, radialSegments : number, p : number, q : number )
...
### .[fromJSON](#.fromJSON)( data : Object ) : [TorusKnotGeometry](TorusKnotGeometry.html)
