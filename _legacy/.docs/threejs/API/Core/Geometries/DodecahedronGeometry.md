...
Source URL: https://threejs.org/docs/pages/DodecahedronGeometry.html
...
### new [DodecahedronGeometry](#DodecahedronGeometry)( radius : number, detail : number )
...
### .[fromJSON](#.fromJSON)( data : Object ) : [DodecahedronGeometry](DodecahedronGeometry.html)
