Title: TorusGeometry
Source URL: https://threejs.org/docs/pages/TorusGeometry.html
...
### new [TorusGeometry](#TorusGeometry)( radius : number, tube : number, radialSegments : number, tubularSegments : number, arc : number, thetaStart : number, thetaLength : number )
...
### .[fromJSON](#.fromJSON)( data : Object ) : [TorusGeometry](TorusGeometry.html)
