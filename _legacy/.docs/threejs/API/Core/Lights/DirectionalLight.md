...
Source URL: https://threejs.org/docs/pages/DirectionalLight.html
...
### new [DirectionalLight](#DirectionalLight)( color : number | [Color](Color.html) | string, intensity : number )
...
### .[isDirectionalLight](#isDirectionalLight) : boolean (readonly)

This flag can be used for type testing.

Default is `true`.

### .[shadow](#shadow) : [DirectionalLightShadow](DirectionalLightShadow.html)
