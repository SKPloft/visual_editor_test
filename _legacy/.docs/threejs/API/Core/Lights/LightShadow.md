Title: LightShadow
Source URL: https://threejs.org/docs/pages/LightShadow.html
...
### new [LightShadow](#LightShadow)( camera : [Camera](Camera.html) ) (abstract)
...
### .[blurSamples](#blurSamples) : number
...
### .[map](#map) : [RenderTarget](RenderTarget.html)

The depth map generated using the internal camera; a location beyond a pixel's depth is in shadow. Computed internally during rendering.

Default is `null`.

### .[mapPass](#mapPass) : [RenderTarget](RenderTarget.html)

The distribution map generated using the internal camera; an occlusion is calculated based on the distribution of depths. Computed internally during rendering.

Default is `null`.

### .[mapSize](#mapSize) : [Vector2](Vector2.html)
...
### .[clone](#clone)() : [LightShadow](LightShadow.html)

Returns a new light shadow instance with copied values from this instance.

**Returns:** A clone of this instance.

### .[copy](#copy)( source : [LightShadow](LightShadow.html) ) : [LightShadow](LightShadow.html)
...
### .[getFrameExtents](#getFrameExtents)() : [Vector2](Vector2.html)

Returns the frame extends.

**Returns:** The frame extends.

### .[getFrustum](#getFrustum)() : [Frustum](Frustum.html)

Gets the shadow cameras frustum. Used internally by the renderer to cull objects.

**Returns:** The shadow camera frustum.

### .[getViewport](#getViewport)( viewportIndex : number ) : [Vector4](Vector4.html)
...
### .[getViewportCount](#getViewportCount)() : number
...
### .[updateMatrices](#updateMatrices)( light : [Light](Light.html) )
