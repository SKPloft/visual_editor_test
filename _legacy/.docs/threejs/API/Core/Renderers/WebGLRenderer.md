Title: WebGLRenderer
Source URL: https://threejs.org/docs/pages/WebGLRenderer.html
...
### new [WebGLRenderer](#WebGLRenderer)( parameters : [WebGLRenderer~Options](WebGLRenderer.html#~Options) )
...
### .[capabilities](#capabilities) : [WebGLRenderer~Capabilities](WebGLRenderer.html#~Capabilities)
...
### .[coordinateSystem](#coordinateSystem) : [WebGLCoordinateSystem](global.html#WebGLCoordinateSystem) | [WebGPUCoordinateSystem](global.html#WebGPUCoordinateSystem) (readonly)
...
### .[info](#info) : [WebGLRenderer~Info](WebGLRenderer.html#~Info)
...
### .[isWebGLRenderer](#isWebGLRenderer) : boolean (readonly)

This flag can be used for type testing.

Default is `true`.

### .[localClippingEnabled](#localClippingEnabled) : boolean

Whether the renderer respects object-level clipping planes or not.

Default is `false`.

### .[outputColorSpace](#outputColorSpace) : [SRGBColorSpace](global.html#SRGBColorSpace) | [LinearSRGBColorSpace](global.html#LinearSRGBColorSpace)
...
### .[renderLists](#renderLists) : Object

Manages the render lists of the renderer.

### .[shadowMap](#shadowMap) : [WebGLRenderer~ShadowMap](WebGLRenderer.html#~ShadowMap)
...
### .[transmissionResolutionScale](#transmissionResolutionScale) : number
...
### .[xr](#xr) : [WebXRManager](WebXRManager.html)
...
### .[compile](#compile)( scene : [Object3D](Object3D.html), camera : [Camera](Camera.html), targetScene : [Scene](Scene.html) ) : Set.<[Material](Material.html)\>
...
### .[copyFramebufferToTexture](#copyFramebufferToTexture)( texture : [FramebufferTexture](FramebufferTexture.html), position : [Vector2](Vector2.html), level : number )
...
### .[forceContextRestore](#forceContextRestore)()
...
### .[getContext](#getContext)() : WebGL2RenderingContext

Returns the rendering context.

**Returns:** The rendering context.

### .[getContextAttributes](#getContextAttributes)() : WebGLContextAttributes

Returns the rendering context attributes.

**Returns:** The rendering context attributes.

### .[getCurrentViewport](#getCurrentViewport)( target : [Vector2](Vector2.html) ) : [Vector2](Vector2.html)
...
### .[initRenderTarget](#initRenderTarget)( target : [WebGLRenderTarget](WebGLRenderTarget.html) )
...
### .[readRenderTargetPixels](#readRenderTargetPixels)( renderTarget : [WebGLRenderTarget](WebGLRenderTarget.html), x : number, y : number, width : number, height : number, buffer : TypedArray, activeCubeFaceIndex : number, textureIndex : number )
...
### .[readRenderTargetPixelsAsync](#readRenderTargetPixelsAsync)( renderTarget : [WebGLRenderTarget](WebGLRenderTarget.html), x : number, y : number, width : number, height : number, buffer : TypedArray, activeCubeFaceIndex : number, textureIndex : number ) : Promise.<TypedArray> (async)
...
### .[setAnimationLoop](#setAnimationLoop)( callback : [onAnimationCallback](global.html#onAnimationCallback) )
...
### .[setEffects](#setEffects)( effects : Array )
...
### .[setNodesHandler](#setNodesHandler)( nodesHandler : [WebGLNodesHandler](WebGLNodesHandler.html) )
...
### .[setRenderTarget](#setRenderTarget)( renderTarget : [WebGLRenderTarget](WebGLRenderTarget.html), activeCubeFace : number, activeMipmapLevel : number )
...
### .[setViewport](#setViewport)( x : number | [Vector4](Vector4.html), y : number, width : number, height : number )
