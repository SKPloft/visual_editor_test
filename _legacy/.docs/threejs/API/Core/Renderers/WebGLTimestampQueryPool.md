Title: WebGLTimestampQueryPool
Source URL: https://threejs.org/docs/pages/WebGLTimestampQueryPool.html
...
### new [WebGLTimestampQueryPool](#WebGLTimestampQueryPool)( gl : WebGLRenderingContext | WebGL2RenderingContext, type : string, maxQueries : number )
...
### .[allocateQueriesForContext](#allocateQueriesForContext)( uid : string ) : number
...
### .[beginQuery](#beginQuery)( uid : string )
...
### .[resolveQueriesAsync](#resolveQueriesAsync)() : Promise.<number> (async)
...
### .[resolveQuery](#resolveQuery)( query : WebGLQuery ) : Promise.<number> (async)
