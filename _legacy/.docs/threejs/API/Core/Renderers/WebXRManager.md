Title: WebXRManager
Source URL: https://threejs.org/docs/pages/WebXRManager.html
...
### .[getBaseLayer](#getBaseLayer)() : XRWebGLLayer | XRProjectionLayer
...
### .[getCameraTexture](#getCameraTexture)( xrCamera : XRCamera ) : [Texture](Texture.html)
...
### .[getDepthSensingMesh](#getDepthSensingMesh)() : [Mesh](Mesh.html)
...
### .[getDepthTexture](#getDepthTexture)() : [Texture](Texture.html)
...
### .[hasDepthSensing](#hasDepthSensing)() : boolean

Returns `true` if depth sensing is supported.

**Returns:** Whether depth sensing is supported or not.

### .[setFoveation](#setFoveation)( value : number )
...
### .[setFramebufferScaleFactor](#setFramebufferScaleFactor)( value : number )
...
### .[setReferenceSpaceType](#setReferenceSpaceType)( value : string )
...
### .[setSession](#setSession)( value : XRSession ) : Promise (async)
...
### .[updateCamera](#updateCamera)( camera : [Camera](Camera.html) )
