...
Source URL: https://threejs.org/docs/pages/StorageInstancedBufferAttribute.html
...
### new [StorageInstancedBufferAttribute](#StorageInstancedBufferAttribute)( count : number | TypedArray, itemSize : number, typeClass : TypedArray.constructor )
...
### .[isStorageInstancedBufferAttribute](#isStorageInstancedBufferAttribute) : boolean (readonly)
