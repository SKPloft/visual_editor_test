...
Source URL: https://threejs.org/docs/pages/IndirectStorageBufferAttribute.html
...
### new [IndirectStorageBufferAttribute](#IndirectStorageBufferAttribute)( count : number | Uint32Array, itemSize : number )
...
### .[isIndirectStorageBufferAttribute](#isIndirectStorageBufferAttribute) : boolean (readonly)
