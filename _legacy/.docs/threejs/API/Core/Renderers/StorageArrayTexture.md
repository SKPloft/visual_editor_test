Title: StorageArrayTexture
Source URL: https://threejs.org/docs/pages/StorageArrayTexture.html
...
### new [StorageArrayTexture](#StorageArrayTexture)( width : number, height : number, depth : number )
