Title: WGSLNodeBuilder
Source URL: https://threejs.org/docs/pages/WGSLNodeBuilder.html
...
### new [WGSLNodeBuilder](#WGSLNodeBuilder)( object : [Object3D](Object3D.html), renderer : [Renderer](Renderer.html) )
...
### .[allowEarlyReturns](#allowEarlyReturns) : boolean

A flag that indicates that early returns are allowed.

Default is `true`.

### .[allowGlobalVariables](#allowGlobalVariables) : boolean

A flag that indicates that global variables are allowed.

Default is `true`.

### .[builtins](#builtins) : Object.<string, Map.<string, Object>>

A dictionary that holds for each shader stage a Map of builtins.

### .[directives](#directives) : Object.<string, Set.<string>>

A dictionary that holds for each shader stage a Set of directives.

### .[scopedArrays](#scopedArrays) : Map.<string, Object>
...
### .[uniformGroupsBindings](#uniformGroupsBindings) : Object.<string, {index: number, id: number}>
...
### .[enableDirective](#enableDirective)( name : string, shaderStage : string )
...
### .[enableDualSourceBlending](#enableDualSourceBlending)()
...
### .[enableShaderF16](#enableShaderF16)()

Enables the 'f16' directive.

### .[enableSubGroups](#enableSubGroups)()

Enables the 'subgroups' directive.

### .[enableSubgroupsF16](#enableSubgroupsF16)()
...
### .[generateFilteredTexture](#generateFilteredTexture)( texture : [Texture](Texture.html), textureProperty : string, uvSnippet : string, offsetSnippet : string, levelSnippet : string, depthSnippet : string ) : string
...
### .[generateStorageTextureLoad](#generateStorageTextureLoad)( texture : [Texture](Texture.html), textureProperty : string, uvIndexSnippet : string, levelSnippet : string, depthSnippet : string, offsetSnippet : string ) : string
...
### .[generateTexture](#generateTexture)( texture : [Texture](Texture.html), textureProperty : string, uvSnippet : string, depthSnippet : string, offsetSnippet : string, shaderStage : string ) : string
...
### .[generateTextureBias](#generateTextureBias)( texture : [Texture](Texture.html), textureProperty : string, uvSnippet : string, biasSnippet : string, depthSnippet : string, offsetSnippet : string, shaderStage : string ) : string
...
### .[generateTextureDimension](#generateTextureDimension)( texture : [Texture](Texture.html), textureProperty : string, levelSnippet : string ) : string
...
### .[generateTextureGrad](#generateTextureGrad)( texture : [Texture](Texture.html), textureProperty : string, uvSnippet : string, gradSnippet : Array.<string>, depthSnippet : string, offsetSnippet : string, shaderStage : string ) : string
...
### .[generateTextureLevel](#generateTextureLevel)( texture : [Texture](Texture.html), textureProperty : string, uvSnippet : string, levelSnippet : string, depthSnippet : string, offsetSnippet : string, shaderStage : string ) : string
...
### .[generateTextureLod](#generateTextureLod)( texture : [Texture](Texture.html), textureProperty : string, uvSnippet : string, depthSnippet : string, offsetSnippet : string, levelSnippet : string ) : string
...
### .[generateTextureStore](#generateTextureStore)( texture : [Texture](Texture.html), textureProperty : string, uvIndexSnippet : string, depthSnippet : string, valueSnippet : string ) : string
...
### .[generateWrapFunction](#generateWrapFunction)( texture : [Texture](Texture.html) ) : string
...
### .[getBitcastMethod](#getBitcastMethod)( type : string ) : string
...
### .[getBuiltin](#getBuiltin)( name : string, property : string, type : string, shaderStage : string ) : string
...
### .[getBuiltins](#getBuiltins)( shaderStage : string ) : string
...
### .[getDirectives](#getDirectives)( shaderStage : string ) : string
...
### .[getDrawIndex](#getDrawIndex)() : null
...
### .[getFunctionOperator](#getFunctionOperator)( op : string ) : string
...
### .[getInvocationSubgroupIndex](#getInvocationSubgroupIndex)() : string
...
### .[getMethod](#getMethod)( method : string, output : string ) : string
...
### .[getNodeAccess](#getNodeAccess)( node : [StorageTextureNode](StorageTextureNode.html) | [StorageBufferNode](StorageBufferNode.html), shaderStage : string ) : string
...
### .[getScopedArray](#getScopedArray)( name : string, scope : string, bufferType : string, bufferCount : string ) : string
...
### .[getScopedArrays](#getScopedArrays)( shaderStage : string ) : string | undefined
...
### .[getStorageAccess](#getStorageAccess)( node : [StorageTextureNode](StorageTextureNode.html) | [StorageBufferNode](StorageBufferNode.html), shaderStage : string ) : string
...
### .[getSubgroupIndex](#getSubgroupIndex)() : string
...
### .[getSubgroupSize](#getSubgroupSize)() : string
...
### .[getVar](#getVar)( type : string, name : string, count : number, qualifier : string ) : string
...
### .[getVars](#getVars)( shaderStage : string ) : string
...
### .[hasBuiltin](#hasBuiltin)( name : string, shaderStage : string ) : boolean
...
### .[isSampleCompare](#isSampleCompare)( texture : [Texture](Texture.html) ) : boolean
...
### .[isUnfilterable](#isUnfilterable)( texture : [Texture](Texture.html) ) : boolean
