...
Source URL: https://threejs.org/docs/pages/VideoFrameTexture.html
...
### new [VideoFrameTexture](#VideoFrameTexture)( mapping : number, wrapS : number, wrapT : number, magFilter : number, minFilter : number, format : number, type : number, anisotropy : number )
...
### .[isVideoFrameTexture](#isVideoFrameTexture) : boolean (readonly)
...
### .[setFrame](#setFrame)( frame : VideoFrame )
