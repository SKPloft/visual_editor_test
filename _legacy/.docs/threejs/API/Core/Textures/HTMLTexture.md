Title: HTMLTexture
Source URL: https://threejs.org/docs/pages/HTMLTexture.html
...
### new [HTMLTexture](#HTMLTexture)( element : HTMLElement, mapping : number, wrapS : number, wrapT : number, magFilter : number, minFilter : number, format : number, type : number, anisotropy : number )
...
### .[isHTMLTexture](#isHTMLTexture) : boolean (readonly)
