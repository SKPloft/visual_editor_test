Title: CanvasTexture
Source URL: https://threejs.org/docs/pages/CanvasTexture.html
...
### new [CanvasTexture](#CanvasTexture)( canvas : HTMLCanvasElement, mapping : number, wrapS : number, wrapT : number, magFilter : number, minFilter : number, format : number, type : number, anisotropy : number )
...
### .[isCanvasTexture](#isCanvasTexture) : boolean (readonly)
