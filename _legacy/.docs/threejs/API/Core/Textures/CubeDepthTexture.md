...
Source URL: https://threejs.org/docs/pages/CubeDepthTexture.html
...
### new [CubeDepthTexture](#CubeDepthTexture)( size : number, type : number, mapping : number, wrapS : number, wrapT : number, magFilter : number, minFilter : number, anisotropy : number, format : number )
...
### .[isCubeDepthTexture](#isCubeDepthTexture) : boolean (readonly)
