Title: VideoTexture
Source URL: https://threejs.org/docs/pages/VideoTexture.html
...
### new [VideoTexture](#VideoTexture)( video : HTMLVideoElement, mapping : number, wrapS : number, wrapT : number, magFilter : number, minFilter : number, format : number, type : number, anisotropy : number )
...
### .[isVideoTexture](#isVideoTexture) : boolean (readonly)
