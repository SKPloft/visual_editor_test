...
Source URL: https://threejs.org/docs/pages/CompressedTexture.html
...
### new [CompressedTexture](#CompressedTexture)( mipmaps : Array.<Object>, width : number, height : number, format : number, type : number, mapping : number, wrapS : number, wrapT : number, magFilter : number, minFilter : number, anisotropy : number, colorSpace : string )
...
### .[generateMipmaps](#generateMipmaps) : boolean (readonly)
...
### .[isCompressedTexture](#isCompressedTexture) : boolean (readonly)
