Title: BatchedMesh
Source URL: https://threejs.org/docs/pages/BatchedMesh.html
...
### new [BatchedMesh](#BatchedMesh)( maxInstanceCount : number, maxVertexCount : number, maxIndexCount : number, material : [Material](Material.html) | Array.<[Material](Material.html)\> )
...
### .[customSort](#customSort) : function
...
### .[instanceCount](#instanceCount) : number (readonly)

The instance count.

### .[isBatchedMesh](#isBatchedMesh) : boolean (readonly)

This flag can be used for type testing.

Default is `true`.

### .[maxInstanceCount](#maxInstanceCount) : number (readonly)

The maximum number of individual instances that can be stored in the batch.

### .[perObjectFrustumCulled](#perObjectFrustumCulled) : boolean
...
### .[unusedIndexCount](#unusedIndexCount) : number (readonly)

The number of unused indices.

### .[unusedVertexCount](#unusedVertexCount) : number (readonly)

The number of unused vertices.

## Methods

### .[addGeometry](#addGeometry)( geometry : [BufferGeometry](BufferGeometry.html), reservedVertexCount : number, reservedIndexCount : number ) : number
...
### .[addInstance](#addInstance)( geometryId : number ) : number
...
### .[deleteGeometry](#deleteGeometry)( geometryId : number ) : [BatchedMesh](BatchedMesh.html)
...
### .[deleteInstance](#deleteInstance)( instanceId : number ) : [BatchedMesh](BatchedMesh.html)
...
### .[getBoundingBoxAt](#getBoundingBoxAt)( geometryId : number, target : [Box3](Box3.html) ) : [Box3](Box3.html)
...
### .[getBoundingSphereAt](#getBoundingSphereAt)( geometryId : number, target : [Sphere](Sphere.html) ) : [Sphere](Sphere.html)
...
### .[getColorAt](#getColorAt)( instanceId : number, color : [Color](Color.html) | [Vector4](Vector4.html) ) : [Color](Color.html) | [Vector4](Vector4.html)
...
### .[getGeometryIdAt](#getGeometryIdAt)( instanceId : number ) : number
...
### .[getGeometryRangeAt](#getGeometryRangeAt)( geometryId : number, target : Object ) : Object
...
### .[getMatrixAt](#getMatrixAt)( instanceId : number, matrix : [Matrix4](Matrix4.html) ) : [Matrix4](Matrix4.html)
...
### .[getVisibleAt](#getVisibleAt)( instanceId : number ) : boolean
...
### .[optimize](#optimize)() : [BatchedMesh](BatchedMesh.html)
...
### .[setColorAt](#setColorAt)( instanceId : number, color : [Color](Color.html) | [Vector4](Vector4.html) ) : [BatchedMesh](BatchedMesh.html)
...
### .[setCustomSort](#setCustomSort)( func : function ) : [BatchedMesh](BatchedMesh.html)
...
### .[setGeometryAt](#setGeometryAt)( geometryId : number, geometry : [BufferGeometry](BufferGeometry.html) ) : number
...
### .[setGeometryIdAt](#setGeometryIdAt)( instanceId : number, geometryId : number ) : [BatchedMesh](BatchedMesh.html)
...
### .[setGeometrySize](#setGeometrySize)( maxVertexCount : number, maxIndexCount : number )
...
### .[setInstanceCount](#setInstanceCount)( maxInstanceCount : number )
...
### .[setMatrixAt](#setMatrixAt)( instanceId : number, matrix : [Matrix4](Matrix4.html) ) : [BatchedMesh](BatchedMesh.html)
...
### .[setVisibleAt](#setVisibleAt)( instanceId : number, visible : boolean ) : [BatchedMesh](BatchedMesh.html)
...
### .[validateGeometryId](#validateGeometryId)( geometryId : number )
...
### .[validateInstanceId](#validateInstanceId)( instanceId : number )
