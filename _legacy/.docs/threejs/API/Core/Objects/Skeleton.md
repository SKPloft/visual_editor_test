Title: Skeleton
Source URL: https://threejs.org/docs/pages/Skeleton.html
...
### new [Skeleton](#Skeleton)( bones : Array.<[Bone](Bone.html)\>, boneInverses : Array.<[Matrix4](Matrix4.html)\> )
...
### .[boneInverses](#boneInverses) : Array.<[Matrix4](Matrix4.html)\>

An array of bone inverse matrices.

### .[boneMatrices](#boneMatrices) : Float32Array

An array buffer holding the bone data. Input data for [Skeleton#boneTexture](Skeleton.html#boneTexture).

Default is `null`.

### .[boneTexture](#boneTexture) : [DataTexture](DataTexture.html)
...
### .[previousBoneMatrices](#previousBoneMatrices) : Float32Array
...
### .[calculateInverses](#calculateInverses)()
...
### .[clone](#clone)() : [Skeleton](Skeleton.html)

Returns a new skeleton with copied values from this instance.

**Returns:** A clone of this instance.

### .[computeBoneTexture](#computeBoneTexture)() : [Skeleton](Skeleton.html)
...
### .[fromJSON](#fromJSON)( json : Object, bones : Object.<string, [Bone](Bone.html)\> ) : [Skeleton](Skeleton.html)
...
### .[getBoneByName](#getBoneByName)( name : string ) : [Bone](Bone.html) | undefined
