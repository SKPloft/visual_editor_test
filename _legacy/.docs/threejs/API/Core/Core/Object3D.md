Title: object3d
Source URL: https://threejs.org/docs/pages/Object3D.html
...
### .[animations](#animations) : Array.<[AnimationClip](AnimationClip.html)\>

An array holding the animation clips of the 3D object.

### .[castShadow](#castShadow) : boolean

When set to `true`, the 3D object gets rendered into shadow maps.

Default is `false`.

### .[children](#children) : Array.<[Object3D](Object3D.html)\>

An array holding the child 3D objects of this instance.

### .[customDepthMaterial](#customDepthMaterial) : [Material](Material.html) | undefined
...
### .[customDistanceMaterial](#customDistanceMaterial) : [Material](Material.html) | undefined
...
### .[frustumCulled](#frustumCulled) : boolean
...
### .[isObject3D](#isObject3D) : boolean (readonly)
...
### .[matrix](#matrix) : [Matrix4](Matrix4.html)

Represents the object's transformation matrix in local space.

### .[matrixAutoUpdate](#matrixAutoUpdate) : boolean
...
### .[matrixWorld](#matrixWorld) : [Matrix4](Matrix4.html)
...
### .[matrixWorldAutoUpdate](#matrixWorldAutoUpdate) : boolean
...
### .[matrixWorldNeedsUpdate](#matrixWorldNeedsUpdate) : boolean

When set to `true`, it calculates the world matrix in that frame and resets this property to `false`.

Default is `false`.

### .[modelViewMatrix](#modelViewMatrix) : [Matrix4](Matrix4.html)
...
### .[normalMatrix](#normalMatrix) : [Matrix3](Matrix3.html)
...
### .[pivot](#pivot) : [Vector3](Vector3.html)
...
### .[position](#position) : [Vector3](Vector3.html)

Represents the object's local position.

Default is `(0,0,0)`.

### .[quaternion](#quaternion) : [Quaternion](Quaternion.html)

Represents the object's local rotation as Quaternions.

### .[receiveShadow](#receiveShadow) : boolean
...
### .[rotation](#rotation) : [Euler](Euler.html)

Represents the object's local rotation as Euler angles, in radians.

Default is `(0,0,0)`.

### .[scale](#scale) : [Vector3](Vector3.html)
...
### .[add](#add)( object : [Object3D](Object3D.html) ) : [Object3D](Object3D.html)
...
### .[applyMatrix4](#applyMatrix4)( matrix : [Matrix4](Matrix4.html) )
...
### .[applyQuaternion](#applyQuaternion)( q : [Quaternion](Quaternion.html) ) : [Object3D](Object3D.html)
...
### .[attach](#attach)( object : [Object3D](Object3D.html) ) : [Object3D](Object3D.html)
...
### .[clear](#clear)() : [Object3D](Object3D.html)
...
### .[clone](#clone)( recursive : boolean ) : [Object3D](Object3D.html)
...
### .[copy](#copy)( source : [Object3D](Object3D.html), recursive : boolean ) : [Object3D](Object3D.html)
...
### .[getObjectById](#getObjectById)( id : number ) : [Object3D](Object3D.html) | undefined
...
### .[getObjectByName](#getObjectByName)( name : string ) : [Object3D](Object3D.html) | undefined
...
### .[getObjectByProperty](#getObjectByProperty)( name : string, value : [any](global.html#any) ) : [Object3D](Object3D.html) | undefined
...
### .[getObjectsByProperty](#getObjectsByProperty)( name : string, value : [any](global.html#any), result : Array.<[Object3D](Object3D.html)\> ) : Array.<[Object3D](Object3D.html)\>
...
### .[getWorldDirection](#getWorldDirection)( target : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
...
### .[getWorldPosition](#getWorldPosition)( target : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
...
### .[getWorldQuaternion](#getWorldQuaternion)( target : [Quaternion](Quaternion.html) ) : [Quaternion](Quaternion.html)
...
### .[getWorldScale](#getWorldScale)( target : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
...
### .[localToWorld](#localToWorld)( vector : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
...
### .[lookAt](#lookAt)( x : number | [Vector3](Vector3.html), y : number, z : number )
...
### .[onAfterRender](#onAfterRender)( renderer : [Renderer](Renderer.html) | [WebGLRenderer](WebGLRenderer.html), object : [Object3D](Object3D.html), camera : [Camera](Camera.html), geometry : [BufferGeometry](BufferGeometry.html), material : [Material](Material.html), group : Object )
...
### .[onAfterShadow](#onAfterShadow)( renderer : [Renderer](Renderer.html) | [WebGLRenderer](WebGLRenderer.html), object : [Object3D](Object3D.html), camera : [Camera](Camera.html), shadowCamera : [Camera](Camera.html), geometry : [BufferGeometry](BufferGeometry.html), depthMaterial : [Material](Material.html), group : Object )
...
### .[onBeforeRender](#onBeforeRender)( renderer : [Renderer](Renderer.html) | [WebGLRenderer](WebGLRenderer.html), object : [Object3D](Object3D.html), camera : [Camera](Camera.html), geometry : [BufferGeometry](BufferGeometry.html), material : [Material](Material.html), group : Object )
...
### .[onBeforeShadow](#onBeforeShadow)( renderer : [Renderer](Renderer.html) | [WebGLRenderer](WebGLRenderer.html), object : [Object3D](Object3D.html), camera : [Camera](Camera.html), shadowCamera : [Camera](Camera.html), geometry : [BufferGeometry](BufferGeometry.html), depthMaterial : [Material](Material.html), group : Object )
...
### .[raycast](#raycast)( raycaster : [Raycaster](Raycaster.html), intersects : Array.<Object> ) (abstract)
...
### .[remove](#remove)( object : [Object3D](Object3D.html) ) : [Object3D](Object3D.html)
...
### .[removeFromParent](#removeFromParent)() : [Object3D](Object3D.html)
...
### .[rotateOnAxis](#rotateOnAxis)( axis : [Vector3](Vector3.html), angle : number ) : [Object3D](Object3D.html)
...
### .[rotateOnWorldAxis](#rotateOnWorldAxis)( axis : [Vector3](Vector3.html), angle : number ) : [Object3D](Object3D.html)
...
### .[rotateX](#rotateX)( angle : number ) : [Object3D](Object3D.html)
...
### .[rotateY](#rotateY)( angle : number ) : [Object3D](Object3D.html)
...
### .[rotateZ](#rotateZ)( angle : number ) : [Object3D](Object3D.html)
...
### .[setRotationFromAxisAngle](#setRotationFromAxisAngle)( axis : [Vector3](Vector3.html), angle : number )
...
### .[setRotationFromEuler](#setRotationFromEuler)( euler : [Euler](Euler.html) )
...
### .[setRotationFromMatrix](#setRotationFromMatrix)( m : [Matrix4](Matrix4.html) )
...
### .[setRotationFromQuaternion](#setRotationFromQuaternion)( q : [Quaternion](Quaternion.html) )
...
### .[translateOnAxis](#translateOnAxis)( axis : [Vector3](Vector3.html), distance : number ) : [Object3D](Object3D.html)
...
### .[translateX](#translateX)( distance : number ) : [Object3D](Object3D.html)
...
### .[translateY](#translateY)( distance : number ) : [Object3D](Object3D.html)
...
### .[translateZ](#translateZ)( distance : number ) : [Object3D](Object3D.html)
...
### .[traverse](#traverse)( callback : function )
...
### .[traverseAncestors](#traverseAncestors)( callback : function )
...
### .[traverseVisible](#traverseVisible)( callback : function )
...
### .[updateWorldMatrix](#updateWorldMatrix)( updateParents : boolean, updateChildren : boolean )
...
### .[worldToLocal](#worldToLocal)( vector : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
