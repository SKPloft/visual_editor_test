Title: Raycaster
Source URL: https://threejs.org/docs/pages/Raycaster.html
...
### new [Raycaster](#Raycaster)( origin : [Vector3](Vector3.html), direction : [Vector3](Vector3.html), near : number, far : number )
...
### .[ray](#ray) : [Ray](Ray.html)

The ray used for raycasting.

## Methods

### .[intersectObject](#intersectObject)( object : [Object3D](Object3D.html), recursive : boolean, intersects : Array.<[Raycaster~Intersection](Raycaster.html#~Intersection)\> ) : Array.<[Raycaster~Intersection](Raycaster.html#~Intersection)\>
...
### .[intersectObjects](#intersectObjects)( objects : Array.<[Object3D](Object3D.html)\>, recursive : boolean, intersects : Array.<[Raycaster~Intersection](Raycaster.html#~Intersection)\> ) : Array.<[Raycaster~Intersection](Raycaster.html#~Intersection)\>
...
### .[set](#set)( origin : [Vector3](Vector3.html), direction : [Vector3](Vector3.html) )
...
### .[setFromCamera](#setFromCamera)( coords : [Vector2](Vector2.html), camera : [Camera](Camera.html) )
...
### .[setFromXRController](#setFromXRController)( controller : [WebXRController](WebXRController.html) ) : [Raycaster](Raycaster.html)
