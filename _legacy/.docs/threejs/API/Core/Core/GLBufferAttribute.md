...
Source URL: https://threejs.org/docs/pages/GLBufferAttribute.html
...
### new [GLBufferAttribute](#GLBufferAttribute)( buffer : WebGLBuffer, type : number, itemSize : number, elementSize : number, count : number, normalized : boolean )
...
### .[elementSize](#elementSize) : number

The corresponding size (in bytes) for the given `type` parameter.

### .[isGLBufferAttribute](#isGLBufferAttribute) : boolean (readonly)
...
### .[setBuffer](#setBuffer)( buffer : WebGLBuffer ) : [BufferAttribute](BufferAttribute.html)
...
### .[setCount](#setCount)( count : number ) : [BufferAttribute](BufferAttribute.html)
...
### .[setItemSize](#setItemSize)( itemSize : number ) : [BufferAttribute](BufferAttribute.html)
...
### .[setType](#setType)( type : number, elementSize : number ) : [BufferAttribute](BufferAttribute.html)
