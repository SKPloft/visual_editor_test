Title: Layers
Source URL: https://threejs.org/docs/pages/Layers.html
...
### .[isEnabled](#isEnabled)( layer : number ) : boolean
...
### .[test](#test)( layers : [Layers](Layers.html) ) : boolean
