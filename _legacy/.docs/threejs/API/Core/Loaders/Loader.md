Title: Loader
Source URL: https://threejs.org/docs/pages/Loader.html
...
### new [Loader](#Loader)( manager : [LoadingManager](LoadingManager.html) ) (abstract)
...
### .[manager](#manager) : [LoadingManager](LoadingManager.html)
...
### .[requestHeader](#requestHeader) : Object.<string, [any](global.html#any)\>
...
### .[DEFAULT\_MATERIAL\_NAME](#.DEFAULT_MATERIAL_NAME) : string
...
### .[abort](#abort)() : [Loader](Loader.html) (abstract)

This method can be implemented in loaders for aborting ongoing requests.

**Returns:** A reference to this instance.

### .[load](#load)( url : string, onLoad : function, onProgress : [onProgressCallback](global.html#onProgressCallback), onError : [onErrorCallback](global.html#onErrorCallback) ) (abstract)
...
### .[loadAsync](#loadAsync)( url : string, onProgress : [onProgressCallback](global.html#onProgressCallback) ) : Promise
...
### .[parse](#parse)( data : [any](global.html#any) ) (abstract)
...
### .[setCrossOrigin](#setCrossOrigin)( crossOrigin : string ) : [Loader](Loader.html)
...
### .[setPath](#setPath)( path : string ) : [Loader](Loader.html)
...
### .[setRequestHeader](#setRequestHeader)( requestHeader : Object ) : [Loader](Loader.html)
...
### .[setResourcePath](#setResourcePath)( resourcePath : string ) : [Loader](Loader.html)
...
### .[setWithCredentials](#setWithCredentials)( value : boolean ) : [Loader](Loader.html)
