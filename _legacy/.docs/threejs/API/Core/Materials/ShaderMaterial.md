...
Source URL: https://threejs.org/docs/pages/ShaderMaterial.html
...
### new [ShaderMaterial](#ShaderMaterial)( parameters : Object )
...
### .[defaultAttributeValues](#defaultAttributeValues) : Object
...
### .[glslVersion](#glslVersion) : [GLSL1](global.html#GLSL1) | [GLSL3](global.html#GLSL3)

Defines the GLSL version of custom shader code.

Default is `null`.

### .[index0AttributeName](#index0AttributeName) : string | undefined
...
### .[isShaderMaterial](#isShaderMaterial) : boolean (readonly)
...
### .[uniformsGroups](#uniformsGroups) : Array.<[UniformsGroup](UniformsGroup.html)\>

An array holding uniforms groups for configuring UBOs.

### .[uniformsNeedUpdate](#uniformsNeedUpdate) : boolean
