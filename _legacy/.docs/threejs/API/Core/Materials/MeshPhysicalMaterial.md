...
Source URL: https://threejs.org/docs/pages/MeshPhysicalMaterial.html
...
### new [MeshPhysicalMaterial](#MeshPhysicalMaterial)( parameters : Object )
...
### .[anisotropyMap](#anisotropyMap) : [Texture](Texture.html)
...
### .[anisotropyRotation](#anisotropyRotation) : number
...
### .[attenuationColor](#attenuationColor) : [Color](Color.html)

The color that white light turns into due to absorption when reaching the attenuation distance.

Default is `(1,1,1)`.

### .[attenuationDistance](#attenuationDistance) : number
...
### .[clearcoatMap](#clearcoatMap) : [Texture](Texture.html)

The red channel of this texture is multiplied against `clearcoat`, for per-pixel control over a coating's intensity.

Default is `null`.

### .[clearcoatNormalMap](#clearcoatNormalMap) : [Texture](Texture.html)

Can be used to enable independent normals for the clear coat layer.

Default is `null`.

### .[clearcoatNormalScale](#clearcoatNormalScale) : [Vector2](Vector2.html)

How much `clearcoatNormalMap` affects the clear coat layer, from `(0,0)` to `(1,1)`.

Default is `(1,1)`.

### .[clearcoatRoughness](#clearcoatRoughness) : number

Roughness of the clear coat layer, from `0.0` to `1.0`.

Default is `0`.

### .[clearcoatRoughnessMap](#clearcoatRoughnessMap) : [Texture](Texture.html)
...
### .[iridescence](#iridescence) : number
...
### .[iridescenceThicknessRange](#iridescenceThicknessRange) : Array.<number, number>
...
### .[isMeshPhysicalMaterial](#isMeshPhysicalMaterial) : boolean (readonly)

This flag can be used for type testing.

Default is `true`.

### .[reflectivity](#reflectivity) : number
...
### .[specularIntensityMap](#specularIntensityMap) : [Texture](Texture.html)
...
### .[thicknessMap](#thicknessMap) : [Texture](Texture.html)
...
### .[transmissionMap](#transmissionMap) : [Texture](Texture.html)
