...
Source URL: https://threejs.org/docs/pages/SpriteNodeMaterial.html
...
### new [SpriteNodeMaterial](#SpriteNodeMaterial)( parameters : Object )
...
### .[isSpriteNodeMaterial](#isSpriteNodeMaterial) : boolean (readonly)

This flag can be used for type testing.

Default is `true`.

### .[positionNode](#positionNode) : [Node](Node.html).<vec2>
...
### .[rotationNode](#rotationNode) : [Node](Node.html).<float>
...
### .[sizeAttenuation](#sizeAttenuation) : boolean
