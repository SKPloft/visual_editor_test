...
Source URL: https://threejs.org/docs/pages/AnimationClipCreator.html
...
### .[CreateMaterialColorAnimation](#.CreateMaterialColorAnimation)( duration : number, colors : Array.<[Color](Color.html)\> ) : [AnimationClip](AnimationClip.html)
...
### .[CreatePulsationAnimation](#.CreatePulsationAnimation)( duration : number, pulseScale : number ) : [AnimationClip](AnimationClip.html)
...
### .[CreateRotationAnimation](#.CreateRotationAnimation)( period : number, axis : 'x' | 'y' | 'z' ) : [AnimationClip](AnimationClip.html)
...
### .[CreateScaleAxisAnimation](#.CreateScaleAxisAnimation)( period : number, axis : 'x' | 'y' | 'z' ) : [AnimationClip](AnimationClip.html)
...
### .[CreateShakeAnimation](#.CreateShakeAnimation)( duration : number, shakeScale : [Vector3](Vector3.html) ) : [AnimationClip](AnimationClip.html)
...
### .[CreateVisibilityAnimation](#.CreateVisibilityAnimation)( duration : number ) : [AnimationClip](AnimationClip.html)
