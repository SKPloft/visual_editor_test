Title: CCDIKSolver
Source URL: https://threejs.org/docs/pages/CCDIKSolver.html
...
### new [CCDIKSolver](#CCDIKSolver)( mesh : [SkinnedMesh](SkinnedMesh.html), iks : Array.<[CCDIKSolver~IK](CCDIKSolver.html#~IK)\> )
...
### .[mesh](#mesh) : [SkinnedMesh](SkinnedMesh.html)

The skinned mesh.

## Methods

### .[createHelper](#createHelper)( sphereSize : number ) : [CCDIKHelper](CCDIKHelper.html)
...
### .[update](#update)( globalBlendFactor : number ) : [CCDIKSolver](CCDIKSolver.html)
...
### .[updateOne](#updateOne)( ik : [CCDIKSolver~IK](CCDIKSolver.html#~IK), overrideBlend : number ) : [CCDIKSolver](CCDIKSolver.html)
