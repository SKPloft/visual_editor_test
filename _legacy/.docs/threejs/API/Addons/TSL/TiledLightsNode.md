Title: TiledLightsNode
Source URL: https://threejs.org/docs/pages/TiledLightsNode.html
...
### new [TiledLightsNode](#TiledLightsNode)( maxLights : number, tileSize : number )
