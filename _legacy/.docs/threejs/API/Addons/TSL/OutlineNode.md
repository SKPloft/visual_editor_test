Title: OutlineNode
Source URL: https://threejs.org/docs/pages/OutlineNode.html
...
### new [OutlineNode](#OutlineNode)( scene : [Scene](Scene.html), camera : [Camera](Camera.html), params : Object )
...
### .[edgeGlowNode](#edgeGlowNode) : [Node](Node.html).<float>

Can be used for an animated glow/pulse effect.

### .[edgeThicknessNode](#edgeThicknessNode) : [Node](Node.html).<float>
