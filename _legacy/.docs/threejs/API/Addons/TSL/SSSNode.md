Title: SSSNode
Source URL: https://threejs.org/docs/pages/SSSNode.html
...
### new [SSSNode](#SSSNode)( depthNode : [TextureNode](TextureNode.html), camera : [Camera](Camera.html), mainLight : [DirectionalLight](DirectionalLight.html) )
...
### .[shadowIntensity](#shadowIntensity) : [UniformNode](UniformNode.html).<float>
