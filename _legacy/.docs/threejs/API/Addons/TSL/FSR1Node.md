Title: FSR1Node
Source URL: https://threejs.org/docs/pages/FSR1Node.html
...
### new [FSR1Node](#FSR1Node)( textureNode : [TextureNode](TextureNode.html), sharpness : [Node](Node.html).<float>, denoise : [Node](Node.html).<bool> )
