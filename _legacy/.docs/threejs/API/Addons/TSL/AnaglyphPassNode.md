...
Source URL: https://threejs.org/docs/pages/AnaglyphPassNode.html
...
### new [AnaglyphPassNode](#AnaglyphPassNode)( scene : [Scene](Scene.html), camera : [Camera](Camera.html) )
...
### .[isAnaglyphPassNode](#isAnaglyphPassNode) : boolean (readonly)
