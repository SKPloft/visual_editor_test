Title: ChromaticAberrationNode
Source URL: https://threejs.org/docs/pages/ChromaticAberrationNode.html
...
### new [ChromaticAberrationNode](#ChromaticAberrationNode)( textureNode : [TextureNode](TextureNode.html), strengthNode : [Node](Node.html), centerNode : [Node](Node.html), scaleNode : [Node](Node.html) )
...
### .[centerNode](#centerNode) : [Node](Node.html)

A node holding the center point of the effect.

### .[scaleNode](#scaleNode) : [Node](Node.html)

A node holding the scale factor for stepped scaling.

### .[strengthNode](#strengthNode) : [Node](Node.html)

A node holding the strength of the effect.

### .[textureNode](#textureNode) : [texture](global.html#texture)
