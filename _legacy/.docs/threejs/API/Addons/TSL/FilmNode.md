Title: FilmNode
Source URL: https://threejs.org/docs/pages/FilmNode.html
...
### new [FilmNode](#FilmNode)( inputNode : [Node](Node.html), intensityNode : [Node](Node.html).<float>, uvNode : [Node](Node.html).<vec2> )
