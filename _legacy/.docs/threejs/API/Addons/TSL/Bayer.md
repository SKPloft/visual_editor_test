Title: module-Bayer
Source URL: https://threejs.org/docs/pages/module-Bayer.html
...
### .[bayer16](#.bayer16)( uv : [Node](Node.html).<vec2> ) : [Node](Node.html).<vec4>
...
### .[bayerDither](#.bayerDither)( color : [Node](Node.html).<vec3>, steps : [Node](Node.html).<float> ) : [Node](Node.html).<vec3>
