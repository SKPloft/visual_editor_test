Title: RGBShiftNode
Source URL: https://threejs.org/docs/pages/RGBShiftNode.html
...
### new [RGBShiftNode](#RGBShiftNode)( textureNode : [TextureNode](TextureNode.html), amount : number, angle : number )
...
### .[amount](#amount) : [UniformNode](UniformNode.html).<float>

The amount of the RGB shift.

### .[angle](#angle) : [UniformNode](UniformNode.html).<float>
