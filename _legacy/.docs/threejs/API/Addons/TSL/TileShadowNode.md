Title: TileShadowNode
Source URL: https://threejs.org/docs/pages/TileShadowNode.html
...
### new [TileShadowNode](#TileShadowNode)( light : [Light](Light.html), options : Object )
...
### .[disposeLightsAndNodes](#disposeLightsAndNodes)()
...
### .[generateTiles](#generateTiles)( tilesX : number, tilesY : number ) : Array.<Object>
...
### .[setup](#setup)( builder : Builder ) : [Node](Node.html)
...
### .[syncLightTransformation](#syncLightTransformation)( lwLight : LwLight, sourceLight : [Light](Light.html) )
...
### .[updateLightDirection](#updateLightDirection)()
