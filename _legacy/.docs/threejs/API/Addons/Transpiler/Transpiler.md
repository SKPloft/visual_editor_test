Title: Transpiler
Source URL: https://threejs.org/docs/pages/Transpiler.html
...
### new [Transpiler](#Transpiler)( decoder : GLSLDecoder, encoder : TSLEncoder )
...
### .[parse](#parse)( source : string ) : string
