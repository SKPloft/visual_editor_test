Title: CSS3DSprite
Source URL: https://threejs.org/docs/pages/CSS3DSprite.html
...
### new [CSS3DSprite](#CSS3DSprite)( element : HTMLElement )
...
### .[isCSS3DSprite](#isCSS3DSprite) : boolean (readonly)

This flag can be used for type testing.

Default is `true`.

### .[rotation2D](#rotation2D) : number
