...
Source URL: https://threejs.org/docs/pages/PointerLockControls.html
...
### new [PointerLockControls](#PointerLockControls)( camera : [Camera](Camera.html), domElement : HTMLElement )
...
### .[isLocked](#isLocked) : boolean (readonly)
...
### .[pointerSpeed](#pointerSpeed) : number
...
### .[getDirection](#getDirection)( v : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
...
### .[lock](#lock)( unadjustedMovement : boolean )
...
### .[moveForward](#moveForward)( distance : number )
...
### .[moveRight](#moveRight)( distance : number )
