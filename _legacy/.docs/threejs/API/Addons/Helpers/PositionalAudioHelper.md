...
Source URL: https://threejs.org/docs/pages/PositionalAudioHelper.html
...
### new [PositionalAudioHelper](#PositionalAudioHelper)( audio : [PositionalAudio](PositionalAudio.html), range : number, divisionsInnerAngle : number, divisionsOuterAngle : number )
...
### .[audio](#audio) : [PositionalAudio](PositionalAudio.html)

The audio to visualize.

### .[divisionsInnerAngle](#divisionsInnerAngle) : number

The number of divisions of the inner part of the directional cone.

Default is `16`.

### .[divisionsOuterAngle](#divisionsOuterAngle) : number
