Title: TextureHelper
Source URL: https://threejs.org/docs/pages/TextureHelper.html
...
### new [TextureHelper](#TextureHelper)( texture : [Texture](Texture.html), width : number, height : number, depth : number )
