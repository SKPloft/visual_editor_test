Title: NURBSSurface
Source URL: https://threejs.org/docs/pages/NURBSSurface.html
...
### new [NURBSSurface](#NURBSSurface)( degree1 : number, degree2 : number, knots1 : Array.<number>, knots2 : Array.<number>, controlPoints : Array.<Array.<([Vector2](Vector2.html)|[Vector3](Vector3.html)|[Vector4](Vector4.html))>> )
...
### .[controlPoints](#controlPoints) : Array.<Array.<([Vector2](Vector2.html)|[Vector3](Vector3.html)|[Vector4](Vector4.html))>>

An array holding arrays of control points.

### .[degree1](#degree1) : number

The first NURBS degree.

### .[degree2](#degree2) : number

The second NURBS degree.

### .[knots1](#knots1) : Array.<number>

The first knots as a flat array of numbers.

### .[knots2](#knots2) : Array.<number>

The second knots as a flat array of numbers.

## Methods

### .[getPoint](#getPoint)( t1 : number, t2 : number, target : [Vector3](Vector3.html) )
