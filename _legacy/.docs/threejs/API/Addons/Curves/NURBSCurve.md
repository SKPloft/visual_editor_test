Title: NURBSCurve
Source URL: https://threejs.org/docs/pages/NURBSCurve.html
...
### new [NURBSCurve](#NURBSCurve)( degree : number, knots : Array.<number>, controlPoints : Array.<([Vector2](Vector2.html)|[Vector3](Vector3.html)|[Vector4](Vector4.html))>, startKnot : number, endKnot : number )
...
### .[controlPoints](#controlPoints) : Array.<[Vector4](Vector4.html)\>
...
### .[endKnot](#endKnot) : number

Index of the end knot into the `knots` array.

### .[knots](#knots) : Array.<number>

The knots as a flat array of numbers.

### .[startKnot](#startKnot) : number
...
### .[getTangent](#getTangent)( t : number, optionalTarget : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
