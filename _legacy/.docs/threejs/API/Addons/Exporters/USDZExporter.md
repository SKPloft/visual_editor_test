Title: USDZExporter
Source URL: https://threejs.org/docs/pages/USDZExporter.html
...
### .[parse](#parse)( scene : [Object3D](Object3D.html), onDone : [USDZExporter~OnDone](USDZExporter.html#~OnDone), onError : [USDZExporter~OnError](USDZExporter.html#~OnError), options : [USDZExporter~Options](USDZExporter.html#~Options) )
...
### .[parseAsync](#parseAsync)( scene : [Object3D](Object3D.html), options : [USDZExporter~Options](USDZExporter.html#~Options) ) : Promise.<ArrayBuffer> (async)
...
### .[setTextureUtils](#setTextureUtils)( utils : [WebGLTextureUtils](WebGLTextureUtils.html) | [WebGPUTextureUtils](WebGPUTextureUtils.html) )
...
### .[OnDone](#~OnDone)( result : ArrayBuffer )
