...
Source URL: https://threejs.org/docs/pages/LensflareElement.html
...
### new [LensflareElement](#LensflareElement)( texture : [Texture](Texture.html), size : number, distance : number, color : [Color](Color.html) )
