Title: Water
Source URL: https://threejs.org/docs/pages/Water.html
...
### new [Water](#Water)( geometry : [BufferGeometry](BufferGeometry.html), options : [Water~Options](Water.html#~Options) )
...
### .[isWater](#isWater) : boolean (readonly)
