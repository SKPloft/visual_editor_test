Title: module-GTAOShader
Source URL: https://threejs.org/docs/pages/module-GTAOShader.html
...
### .[GTAOBlendShader](#~GTAOBlendShader) : Object (inner, constant)

GTAO blend shader. Use by [GTAOPass](GTAOPass.html).

### .[GTAODepthShader](#~GTAODepthShader) : Object (inner, constant)

GTAO depth shader. Use by [GTAOPass](GTAOPass.html).

### .[GTAOShader](#~GTAOShader) : [ShaderMaterial~Shader](ShaderMaterial.html#~Shader) (inner, constant)
