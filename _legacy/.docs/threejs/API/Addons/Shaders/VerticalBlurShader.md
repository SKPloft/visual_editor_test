Title: module-VerticalBlurShader
Source URL: https://threejs.org/docs/pages/module-VerticalBlurShader.html
...
### .[VerticalBlurShader](#~VerticalBlurShader) : [ShaderMaterial~Shader](ShaderMaterial.html#~Shader) (inner, constant)
