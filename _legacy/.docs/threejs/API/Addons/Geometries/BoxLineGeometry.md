...
Source URL: https://threejs.org/docs/pages/BoxLineGeometry.html
...
### new [BoxLineGeometry](#BoxLineGeometry)( width : number, height : number, depth : number, widthSegments : number, heightSegments : number, depthSegments : number )
