...
Source URL: https://threejs.org/docs/pages/RoundedBoxGeometry.html
...
### new [RoundedBoxGeometry](#RoundedBoxGeometry)( width : number, height : number, depth : number, segments : number, radius : number )
...
### .[fromJSON](#.fromJSON)( data : Object ) : [RoundedBoxGeometry](RoundedBoxGeometry.html)
