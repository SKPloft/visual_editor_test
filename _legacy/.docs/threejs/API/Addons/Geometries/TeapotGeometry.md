...
Source URL: https://threejs.org/docs/pages/TeapotGeometry.html
...
### new [TeapotGeometry](#TeapotGeometry)( size : number, segments : number, bottom : boolean, lid : boolean, body : boolean, fitLid : boolean, blinn : boolean )
