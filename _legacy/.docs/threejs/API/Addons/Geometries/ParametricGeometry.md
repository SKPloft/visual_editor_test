...
Source URL: https://threejs.org/docs/pages/ParametricGeometry.html
...
### new [ParametricGeometry](#ParametricGeometry)( func : [ParametricGeometry~Func](ParametricGeometry.html#~Func), slices : number, stacks : number )
...
### .[Func](#~Func)( u : number, v : number, target : [Vector3](Vector3.html) )
