...
Source URL: https://threejs.org/docs/pages/EdgeSplitModifier.html
...
### .[modify](#modify)( geometry : [BufferGeometry](BufferGeometry.html), cutOffAngle : number, tryKeepNormals : boolean ) : [BufferGeometry](BufferGeometry.html)
