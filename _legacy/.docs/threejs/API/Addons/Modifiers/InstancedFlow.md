Title: InstancedFlow
Source URL: https://threejs.org/docs/pages/InstancedFlow.html
...
### new [InstancedFlow](#InstancedFlow)( count : number, curveCount : number, geometry : Geometry, material : [Material](Material.html) )
...
### .[moveIndividualAlongCurve](#moveIndividualAlongCurve)( index : number, offset : number )
...
### .[setCurve](#setCurve)( index : number, curveNo : number )
...
### .[writeChanges](#writeChanges)( index : number )
