...
Source URL: https://threejs.org/docs/pages/GPUComputationRenderer.html
...
### new [GPUComputationRenderer](#GPUComputationRenderer)( sizeX : number, sizeY : number, renderer : [WebGLRenderer](WebGLRenderer.html) )
...
### .[addResolutionDefine](#addResolutionDefine)

Adds a resolution defined for the given material shader.

## Methods

### .[addVariable](#addVariable)( variableName : string, computeFragmentShader : string, initialValueTexture : [Texture](Texture.html) ) : Object
...
### .[createRenderTarget](#createRenderTarget)( sizeXTexture : number, sizeYTexture : number, wrapS : number, wrapT : number, minFilter : number, magFilter : number ) : [WebGLRenderTarget](WebGLRenderTarget.html)
...
### .[createTexture](#createTexture)() : [DataTexture](DataTexture.html)
...
### .[doRenderTarget](#doRenderTarget)( material : [Material](Material.html), output : [WebGLRenderTarget](WebGLRenderTarget.html) )
...
### .[getAlternateRenderTarget](#getAlternateRenderTarget)( variable : Object ) : [WebGLRenderTarget](WebGLRenderTarget.html)
...
### .[getCurrentRenderTarget](#getCurrentRenderTarget)( variable : Object ) : [WebGLRenderTarget](WebGLRenderTarget.html)
...
### .[renderTexture](#renderTexture)( input : [Texture](Texture.html), output : [WebGLRenderTarget](WebGLRenderTarget.html) )
...
### .[setDataType](#setDataType)( type : [FloatType](global.html#FloatType) | [HalfFloatType](global.html#HalfFloatType) ) : [GPUComputationRenderer](GPUComputationRenderer.html)
...
### .[setVariableDependencies](#setVariableDependencies)( variable : Object, dependencies : Array.<Object> )
