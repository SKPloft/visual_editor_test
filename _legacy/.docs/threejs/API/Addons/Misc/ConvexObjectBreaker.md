...
Source URL: https://threejs.org/docs/pages/ConvexObjectBreaker.html
...
### new [ConvexObjectBreaker](#ConvexObjectBreaker)( minSizeForBreak : number, smallDelta : number )
...
### .[cutByPlane](#cutByPlane)( object : [Object3D](Object3D.html), plane : [Plane](Plane.html), output : Object ) : number
...
### .[prepareBreakableObject](#prepareBreakableObject)( object : [Object3D](Object3D.html), mass : number, velocity : [Vector3](Vector3.html), angularVelocity : [Vector3](Vector3.html), breakable : boolean )
...
### .[subdivideByImpact](#subdivideByImpact)( object : [Object3D](Object3D.html), pointOfImpact : [Vector3](Vector3.html), normal : [Vector3](Vector3.html), maxRadialIterations : number, maxRandomIterations : number ) : Array.<[Object3D](Object3D.html)\>
