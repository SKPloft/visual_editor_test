...
Source URL: https://threejs.org/docs/pages/ColorConverter.html
...
### .[getHSV](#.getHSV)( color : [Color](Color.html), target : Object ) : Object
...
### .[setHSV](#.setHSV)( color : [Color](Color.html), h : number, s : number, v : number ) : [Color](Color.html)
