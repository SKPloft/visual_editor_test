...
Source URL: https://threejs.org/docs/pages/MeshSurfaceSampler.html
...
### new [MeshSurfaceSampler](#MeshSurfaceSampler)( mesh : [Mesh](Mesh.html) )
...
### .[build](#build)() : [MeshSurfaceSampler](MeshSurfaceSampler.html)
...
### .[sample](#sample)( targetPosition : [Vector3](Vector3.html), targetNormal : [Vector3](Vector3.html), targetColor : [Color](Color.html), targetUV : [Vector2](Vector2.html) ) : [MeshSurfaceSampler](MeshSurfaceSampler.html)
...
### .[setRandomGenerator](#setRandomGenerator)( randomFunction : function ) : [MeshSurfaceSampler](MeshSurfaceSampler.html)
...
### .[setWeightAttribute](#setWeightAttribute)( name : string ) : [MeshSurfaceSampler](MeshSurfaceSampler.html)
