Title: SimplexNoise
Source URL: https://threejs.org/docs/pages/SimplexNoise.html
...
### new [SimplexNoise](#SimplexNoise)( r : Object )
...
### .[noise](#noise)( xin : number, yin : number ) : number
...
### .[noise3d](#noise3d)( xin : number, yin : number, zin : number ) : number
...
### .[noise4d](#noise4d)( x : number, y : number, z : number, w : number ) : number
