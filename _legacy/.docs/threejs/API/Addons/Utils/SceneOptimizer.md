Title: SceneOptimizer
Source URL: https://threejs.org/docs/pages/SceneOptimizer.html
...
### new [SceneOptimizer](#SceneOptimizer)( scene : [Scene](Scene.html), options : [SceneOptimizer~Options](SceneOptimizer.html#~Options) )
...
### .[disposeMeshes](#disposeMeshes)( meshesToRemove : Set.<[Mesh](Mesh.html)\> )
...
### .[removeEmptyNodes](#removeEmptyNodes)( object : [Object3D](Object3D.html) )
...
### .[toBatchedMesh](#toBatchedMesh)() : [Scene](Scene.html)
...
### .[toInstancingMesh](#toInstancingMesh)() : [Scene](Scene.html) (abstract)
