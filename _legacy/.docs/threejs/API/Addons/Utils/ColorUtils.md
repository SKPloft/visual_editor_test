Title: module-ColorUtils
Source URL: https://threejs.org/docs/pages/module-ColorUtils.html
...
### .[setKelvin](#~setKelvin)( color : [Color](Color.html), kelvin : number ) : [Color](Color.html) (inner)
