...
Source URL: https://threejs.org/docs/pages/UnrealBloomPass.html
...
### new [UnrealBloomPass](#UnrealBloomPass)( resolution : [Vector2](Vector2.html), strength : number, radius : number, threshold : number )
