...
Source URL: https://threejs.org/docs/pages/AfterimagePass.html
...
### new [AfterimagePass](#AfterimagePass)( damp : number )
...
### .[compFsMaterial](#compFsMaterial) : [ShaderMaterial](ShaderMaterial.html)

The composition material.

### .[copyFsMaterial](#copyFsMaterial) : [ShaderMaterial](ShaderMaterial.html)
