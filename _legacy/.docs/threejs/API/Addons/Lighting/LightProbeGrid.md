Title: LightProbeGrid
Source URL: https://threejs.org/docs/pages/LightProbeGrid.html
...
### new [LightProbeGrid](#LightProbeGrid)( width : number, height : number, depth : number, widthProbes : number, heightProbes : number, depthProbes : number )
...
### .[isLightProbeGrid](#isLightProbeGrid) : boolean (readonly)

This flag can be used for type testing.

Default is `true`.

### .[resolution](#resolution) : [Vector3](Vector3.html)

The number of probes along each axis.

### .[texture](#texture) : [Data3DTexture](Data3DTexture.html)
...
### .[bake](#bake)( renderer : [WebGLRenderer](WebGLRenderer.html), scene : [Scene](Scene.html), options : Object )
...
### .[getProbePosition](#getProbePosition)( ix : number, iy : number, iz : number, target : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
