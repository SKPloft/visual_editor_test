Title: LDrawLoader
Source URL: https://threejs.org/docs/pages/LDrawLoader.html
...
### new [LDrawLoader](#LDrawLoader)( manager : [LoadingManager](LoadingManager.html) )
...
### .[addDefaultMaterials](#addDefaultMaterials)() : [LDrawLoader](LDrawLoader.html)

Initializes the loader with default materials.

**Returns:** A reference to this loader.

### .[addMaterial](#addMaterial)( material : [Material](Material.html) ) : [LDrawLoader](LDrawLoader.html)
...
### .[addMaterials](#addMaterials)( materials : Array.<[Material](Material.html)\> ) : [LDrawLoader](LDrawLoader.html)
...
### .[clearMaterials](#clearMaterials)() : [LDrawLoader](LDrawLoader.html)

Clears the loader's material library.

**Returns:** A reference to this loader.

### .[getMainEdgeMaterial](#getMainEdgeMaterial)() : [Material](Material.html)

Returns the material for the edges main LDraw color.

**Returns:** The material. Returns `null` if no material has been found.

### .[getMainMaterial](#getMainMaterial)() : [Material](Material.html)
...
### .[getMaterial](#getMaterial)( colorCode : string ) : [Material](Material.html)
...
### .[parse](#parse)( text : string, onLoad : function, onError : [onErrorCallback](global.html#onErrorCallback) )
...
### .[preloadMaterials](#preloadMaterials)( url : string ) : Promise (async)
...
### .[setConditionalLineMaterial](#setConditionalLineMaterial)( type : LDrawConditionalLineMaterial.constructor | LDrawConditionalLineNodeMaterial.constructor ) : [LDrawLoader](LDrawLoader.html)
...
### .[setFileMap](#setFileMap)( fileMap : Object.<string, string> ) : [LDrawLoader](LDrawLoader.html)
...
### .[setMaterials](#setMaterials)( materials : Array.<[Material](Material.html)\> ) : [LDrawLoader](LDrawLoader.html)
...
### .[setPartsLibraryPath](#setPartsLibraryPath)( path : string ) : [LDrawLoader](LDrawLoader.html)
