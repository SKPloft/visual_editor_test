Title: MTLLoader
Source URL: https://threejs.org/docs/pages/MTLLoader.html
...
### .[parse](#parse)( text : string, path : string ) : MaterialCreator
...
### .[setMaterialOptions](#setMaterialOptions)( value : [MTLLoader~MaterialOptions](MTLLoader.html#~MaterialOptions) ) : [MTLLoader](MTLLoader.html)
