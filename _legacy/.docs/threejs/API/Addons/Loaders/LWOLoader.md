Title: LWOLoader
Source URL: https://threejs.org/docs/pages/LWOLoader.html
...
### new [LWOLoader](#LWOLoader)( manager : [LoadingManager](LoadingManager.html) )
...
### .[parse](#parse)( iffBuffer : ArrayBuffer, path : string, modelName : string ) : Object
