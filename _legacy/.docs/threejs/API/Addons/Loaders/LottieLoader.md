Title: LottieLoader
Source URL: https://threejs.org/docs/pages/LottieLoader.html
...
### new [LottieLoader](#LottieLoader)( manager : [LoadingManager](LoadingManager.html) )
...
### .[load](#load)( url : string, onLoad : function, onProgress : [onProgressCallback](global.html#onProgressCallback), onError : [onErrorCallback](global.html#onErrorCallback) ) : [CanvasTexture](CanvasTexture.html)
...
### .[setQuality](#setQuality)( value : number )
