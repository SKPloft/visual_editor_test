Title: TDSLoader
Source URL: https://threejs.org/docs/pages/TDSLoader.html
...
### new [TDSLoader](#TDSLoader)( manager : [LoadingManager](LoadingManager.html) )
...
### .[parse](#parse)( arraybuffer : ArrayBuffer, path : string ) : [Group](Group.html)
