Title: GCodeLoader
Source URL: https://threejs.org/docs/pages/GCodeLoader.html
...
### new [GCodeLoader](#GCodeLoader)( manager : [LoadingManager](LoadingManager.html) )
...
### .[parse](#parse)( data : string ) : [Group](Group.html)
