Title: DRACOLoader
Source URL: https://threejs.org/docs/pages/DRACOLoader.html
...
### new [DRACOLoader](#DRACOLoader)( manager : [LoadingManager](LoadingManager.html) )
...
### .[parse](#parse)( buffer : ArrayBuffer, onLoad : function, onError : [onErrorCallback](global.html#onErrorCallback) )
...
### .[setDecoderConfig](#setDecoderConfig)( config : Object ) : [DRACOLoader](DRACOLoader.html)
...
### .[setDecoderPath](#setDecoderPath)( path : string ) : [DRACOLoader](DRACOLoader.html)
...
### .[setWorkerLimit](#setWorkerLimit)( workerLimit : number ) : [DRACOLoader](DRACOLoader.html)
