Title: en/loading-3d-models
Source URL: https://threejs.org/manual/en/loading-3d-models.html
...
If you're new to running a local server, begin with [Installation](installation.html) first. Many common errors viewing 3D models can be avoided by hosting files correctly.
