Title: en/creating-text
Source URL: https://threejs.org/manual/en/creating-text.html
...
\[example:webgl\_geometry\_text WebGL / geometry / text\]  
\[example:webgl\_shadowmap WebGL / shadowmap\]
...
*   \[link:http://msdf-bmfont.donmccurdy.com/ msdf-bmfont-web\] _(web-based)_
*   \[link:https://github.com/soimy/msdf-bmfont-xml msdf-bmfont-xml\] _(commandline)_
*   \[link:https://github.com/libgdx/libgdx/wiki/Hiero hiero\] _(desktop app)_
