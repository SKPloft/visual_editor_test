Title: en/faq
Source URL: https://threejs.org/manual/en/faq.html
...
\[link:https://developer.mozilla.org/en-US/docs/Web/HTML/Viewport\_meta\_tag MDN: Using the viewport meta tag\]
...
visible\_height = 2 \* Math.tan( ( Math.PI / 180 ) \* camera.fov / 2 ) \* distance\_from\_camera;
