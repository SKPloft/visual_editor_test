Title: en/webgpu-postprocessing
Source URL: https://threejs.org/manual/en/webgpu-postprocessing.html
...
We want to further improve the packing/unpacking features in the future to offer more ways to pack/unpack MRT data. In the meanwhile, please have a look at the [official examples](https://threejs.org/examples/?q=webgpu%20postprocessing) to get an overview about the existing effects and setups.