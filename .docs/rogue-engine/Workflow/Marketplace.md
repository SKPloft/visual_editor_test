...
Source URL: https://docs.rogueengine.io/Workflow/Marketplace
...
_Dependencies will be installed before your own package_
...
To publish a package of your own creation, first make sure that its visibility is set to `public` and then submit your request to `[[email protected]](/cdn-cgi/l/email-protection)`. At the moment, you can only publish free packages.