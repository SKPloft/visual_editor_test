Title: Workflow/BuildingYourProject
Source URL: https://docs.rogueengine.io/Workflow/BuildingYourProject
...
To build your project go to _File -> Project Settings_. A dialog will pop up where you can set the name of your project, the scenes you wish to load and the **build** button.
...
Your built project will be saved at the root of your project with the name **Build\_\[timestamp\]**.
