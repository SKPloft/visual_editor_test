...
Source URL: https://docs.rogueengine.io/assets/Components
...
[TypeScript (opens new window)](https://www.typescriptlang.org/) is the officially supported language and the recommended option. If you can, please, use TypeScript ❤.
...
Editing components can be as simple as double clicking them or _right click -> open_ the file. It will open in your favorite code editor but, this not the best solution.
...
opening a component can be as simple as double clicking it or _right click -> open_ the file.

This method works perfectly with [VSCode (opens new window)](https://code.visualstudio.com/), which is the officially recommended editor.
