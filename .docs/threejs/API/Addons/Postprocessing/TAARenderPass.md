Title: TAARenderPass
Source URL: https://threejs.org/docs/pages/TAARenderPass.html
...
### new [TAARenderPass](#TAARenderPass)( scene : [Scene](Scene.html), camera : [Camera](Camera.html), clearColor : number | [Color](Color.html) | string, clearAlpha : number )
...
### .[accumulate](#accumulate) : boolean

Whether to accumulate frames or not. This enables the TAA.

Default is `false`.

### .[accumulateIndex](#accumulateIndex) : number
