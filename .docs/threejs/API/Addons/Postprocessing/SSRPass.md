Title: SSRPass
Source URL: https://threejs.org/docs/pages/SSRPass.html
...
### new [SSRPass](#SSRPass)( options : [SSRPass~Options](SSRPass.html#~Options) )
...
### .[distanceAttenuation](#distanceAttenuation) : boolean

Whether to use distance attenuation or not.

Default is `true`.

### .[fresnel](#fresnel) : boolean

Whether to use fresnel or not.

Default is `true`.

### .[groundReflector](#groundReflector) : [ReflectorForSSRPass](ReflectorForSSRPass.html)
...
### .[infiniteThick](#infiniteThick) : boolean
...
### .[selects](#selects) : Array.<[Object3D](Object3D.html)\>
