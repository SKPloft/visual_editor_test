Title: OutputPass
Source URL: https://threejs.org/docs/pages/OutputPass.html
...
### .[isOutputPass](#isOutputPass) : boolean (readonly)

This flag indicates that this is an output pass.

Default is `true`.

### .[material](#material) : [RawShaderMaterial](RawShaderMaterial.html)
