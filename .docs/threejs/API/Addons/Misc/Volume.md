Title: Volume
Source URL: https://threejs.org/docs/pages/Volume.html
...
### new [Volume](#Volume)( xLength : number, yLength : number, zLength : number, type : string, arrayBuffer : ArrayBuffer )
...
### .[RASDimensions](#RASDimensions) : Array.<number>

This array holds the dimensions of the volume in the RAS space

### .[axisOrder](#axisOrder) : Array.<string>
...
### .[inverseMatrix](#inverseMatrix) : Martrix3

The RAS to IJK matrix.

### .[lowerThreshold](#lowerThreshold) : number
...
### .[matrix](#matrix) : Martrix3

The IJK to RAS matrix.

### .[offset](#offset) : Array.<number>
...
### .[sliceList](#sliceList) : Array.<[VolumeSlice](VolumeSlice.html)\>

The list of all the slices associated to this volume

### .[spacing](#spacing) : Array.<number>

Spacing to apply to the volume from IJK to RAS coordinate system

### .[upperThreshold](#upperThreshold) : number
...
### .[access](#access)( i : number, j : number, k : number ) : number
...
### .[computeMinMax](#computeMinMax)() : Array.<number>

Compute the minimum and the maximum of the data in the volume.

**Returns:** The min/max data as `[min,max]`.

### .[extractPerpendicularPlane](#extractPerpendicularPlane)( axis : 'x' | 'y' | 'z', RASIndex : number ) : Object
...
### .[extractSlice](#extractSlice)( axis : 'x' | 'y' | 'z', index : number ) : [VolumeSlice](VolumeSlice.html)
...
### .[getData](#getData)( i : number, j : number, k : number ) : number
...
### .[map](#map)( functionToMap : function, context : Object ) : [Volume](Volume.html)
...
### .[repaintAllSlices](#repaintAllSlices)() : [Volume](Volume.html)
...
### .[reverseAccess](#reverseAccess)( index : number ) : Array.<number>
