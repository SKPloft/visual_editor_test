Title: module-ParametricFunctions
Source URL: https://threejs.org/docs/pages/module-ParametricFunctions.html
...
### .[klein](#~klein)( v : number, u : number, target : [Vector3](Vector3.html) ) (inner)
...
### .[mobius](#~mobius)( u : number, t : number, target : [Vector3](Vector3.html) ) (inner)
...
### .[mobius3d](#~mobius3d)( u : number, t : number, target : [Vector3](Vector3.html) ) (inner)
...
### .[plane](#~plane)( u : number, v : number, target : [Vector3](Vector3.html) ) (inner)
