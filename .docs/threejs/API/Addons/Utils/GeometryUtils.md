Title: module-GeometryUtils
Source URL: https://threejs.org/docs/pages/module-GeometryUtils.html
...
### .[gosper](#~gosper)( size : number ) : Array.<number> (inner)
...
### .[hilbert2D](#~hilbert2D)( center : [Vector3](Vector3.html), size : number, iterations : number, v0 : number, v1 : number, v2 : number, v3 : number ) : Array.<[Vector3](Vector3.html)\> (inner)
...
### .[hilbert3D](#~hilbert3D)( center : [Vector3](Vector3.html), size : number, iterations : number, v0 : number, v1 : number, v2 : number, v3 : number, v4 : number, v5 : number, v6 : number, v7 : number ) : Array.<[Vector3](Vector3.html)\> (inner)
