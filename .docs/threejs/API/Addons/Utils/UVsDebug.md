Title: module-UVsDebug
Source URL: https://threejs.org/docs/pages/module-UVsDebug.html
...
### .[UVsDebug](#~UVsDebug)( geometry : [BufferGeometry](BufferGeometry.html), size : number ) : HTMLCanvasElement (inner)
