...
Source URL: https://threejs.org/docs/pages/InteractiveGroup.html
...
### .[controllers](#controllers) : Array.<[Group](Group.html)\>
...
### .[disconnectXrControllerEvents](#disconnectXrControllerEvents)()

Disconnects this interactive group from all XR controllers.

### .[disconnectionPointerEvents](#disconnectionPointerEvents)()

Disconnects this interactive group from all Pointer and Mouse Events.

### .[listenToPointerEvents](#listenToPointerEvents)( renderer : [WebGPURenderer](WebGPURenderer.html) | [WebGLRenderer](WebGLRenderer.html), camera : [Camera](Camera.html) )
...
### .[listenToXRControllerEvents](#listenToXRControllerEvents)( controller : [Group](Group.html) )
