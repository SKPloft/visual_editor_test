Title: RetroPassNode
Source URL: https://threejs.org/docs/pages/RetroPassNode.html
...
### new [RetroPassNode](#RetroPassNode)( scene : [Scene](Scene.html), camera : [Camera](Camera.html), options : Object )
