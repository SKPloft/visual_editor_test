Title: ParallaxBarrierPassNode
Source URL: https://threejs.org/docs/pages/ParallaxBarrierPassNode.html
...
### new [ParallaxBarrierPassNode](#ParallaxBarrierPassNode)( scene : [Scene](Scene.html), camera : [Camera](Camera.html) )
...
### .[isParallaxBarrierPassNode](#isParallaxBarrierPassNode) : boolean (readonly)
