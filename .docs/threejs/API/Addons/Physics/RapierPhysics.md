Title: RapierPhysics
Source URL: https://threejs.org/docs/pages/RapierPhysics.html
...
### .[addHeightfield](#addHeightfield)( mesh : [Mesh](Mesh.html), width : number, depth : number, heights : Float32Array, scale : Object ) : RigidBody
...
### .[addMesh](#addMesh)( mesh : [Mesh](Mesh.html), mass : number, restitution : number )
...
### .[addScene](#addScene)( scene : [Object3D](Object3D.html) )
...
### .[removeMesh](#removeMesh)( mesh : [Mesh](Mesh.html) )
...
### .[setMeshPosition](#setMeshPosition)( mesh : [Mesh](Mesh.html), position : [Vector3](Vector3.html), index : number )
...
### .[setMeshVelocity](#setMeshVelocity)( mesh : [Mesh](Mesh.html), velocity : [Vector3](Vector3.html), index : number )
