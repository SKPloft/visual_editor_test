Title: OrbitControls
Source URL: https://threejs.org/docs/pages/OrbitControls.html
...
### new [OrbitControls](#OrbitControls)( object : [Object3D](Object3D.html), domElement : HTMLElement )
...
### .[autoRotateSpeed](#autoRotateSpeed) : number
...
### .[cursor](#cursor) : [Vector3](Vector3.html)
...
### .[cursorStyle](#cursorStyle) : 'auto' | 'grab'

Defines the visual representation of the cursor.

Default is `'auto'`.

### .[dampingFactor](#dampingFactor) : number
...
### .[enableDamping](#enableDamping) : boolean
...
### .[maxAzimuthAngle](#maxAzimuthAngle) : number
...
### .[maxPolarAngle](#maxPolarAngle) : number

How far you can orbit vertically, upper limit. Range is `[0, Math.PI]` radians.

Default is `Math.PI`.

### .[maxTargetRadius](#maxTargetRadius) : number
...
### .[minAzimuthAngle](#minAzimuthAngle) : number
...
### .[minPolarAngle](#minPolarAngle) : number

How far you can orbit vertically, lower limit. Range is `[0, Math.PI]` radians.

Default is `0`.

### .[minTargetRadius](#minTargetRadius) : number
...
### .[position0](#position0) : [Vector3](Vector3.html)
...
### .[screenSpacePanning](#screenSpacePanning) : boolean
...
### .[target0](#target0) : [Vector3](Vector3.html)

Used internally by `saveState()` and `reset()`.

### .[touches](#touches) : Object
...
### .[zoomToCursor](#zoomToCursor) : boolean
...
### .[dollyIn](#dollyIn)( dollyScale : number )
...
### .[dollyOut](#dollyOut)( dollyScale : number )
...
### .[getAzimuthalAngle](#getAzimuthalAngle)() : number

Get the current horizontal rotation, in radians.

**Returns:** The current horizontal rotation, in radians.

### .[getDistance](#getDistance)() : number

Returns the distance from the camera to the target.

**Returns:** The distance from the camera to the target.

### .[getPolarAngle](#getPolarAngle)() : number

Get the current vertical rotation, in radians.

**Returns:** The current vertical rotation, in radians.

### .[listenToKeyEvents](#listenToKeyEvents)( domElement : HTMLElement )
...
### .[rotateLeft](#rotateLeft)( angle : number )
...
### .[rotateUp](#rotateUp)( angle : number )
...
### .[stopListenToKeyEvents](#stopListenToKeyEvents)()
