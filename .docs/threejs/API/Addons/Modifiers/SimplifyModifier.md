...
Source URL: https://threejs.org/docs/pages/SimplifyModifier.html
...
### .[modify](#modify)( geometry : [BufferGeometry](BufferGeometry.html), count : number ) : [BufferGeometry](BufferGeometry.html)
