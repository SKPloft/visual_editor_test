Title: OBJLoader
Source URL: https://threejs.org/docs/pages/OBJLoader.html
...
### new [OBJLoader](#OBJLoader)( manager : [LoadingManager](LoadingManager.html) )
...
### .[materials](#materials) : MaterialCreator
...
### .[parse](#parse)( text : string ) : [Group](Group.html)
...
### .[setMaterials](#setMaterials)( materials : MaterialCreator ) : [OBJLoader](OBJLoader.html)
