...
Source URL: https://threejs.org/docs/pages/Rhino3dmLoader.html
...
### new [Rhino3dmLoader](#Rhino3dmLoader)( manager : [LoadingManager](LoadingManager.html) )
...
### .[decodeObjects](#decodeObjects)( buffer : ArrayBuffer, url : string ) : Promise.<[Object3D](Object3D.html)\>
...
### .[parse](#parse)( data : ArrayBuffer, onLoad : function, onError : [onErrorCallback](global.html#onErrorCallback) )
...
### .[setLibraryPath](#setLibraryPath)( path : string ) : [Rhino3dmLoader](Rhino3dmLoader.html)
...
### .[setWorkerLimit](#setWorkerLimit)( workerLimit : number ) : [Rhino3dmLoader](Rhino3dmLoader.html)
