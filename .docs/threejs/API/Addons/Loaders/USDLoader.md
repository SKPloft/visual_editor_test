Title: USDLoader
Source URL: https://threejs.org/docs/pages/USDLoader.html
...
### new [USDLoader](#USDLoader)( manager : [LoadingManager](LoadingManager.html) )
...
### .[parse](#parse)( buffer : ArrayBuffer | string ) : [Group](Group.html)
