Title: GLTFLoader
Source URL: https://threejs.org/docs/pages/GLTFLoader.html
...
### new [GLTFLoader](#GLTFLoader)( manager : [LoadingManager](LoadingManager.html) )
...
### .[parse](#parse)( data : string | ArrayBuffer, path : string, onLoad : function, onError : [onErrorCallback](global.html#onErrorCallback) )
...
### .[parseAsync](#parseAsync)( data : string | ArrayBuffer, path : string ) : Promise.<[GLTFLoader~LoadObject](GLTFLoader.html#~LoadObject)\> (async)
...
### .[register](#register)( callback : function ) : [GLTFLoader](GLTFLoader.html)
...
### .[setDRACOLoader](#setDRACOLoader)( dracoLoader : [DRACOLoader](DRACOLoader.html) ) : [GLTFLoader](GLTFLoader.html)
...
### .[setKTX2Loader](#setKTX2Loader)( ktx2Loader : [KTX2Loader](KTX2Loader.html) ) : [GLTFLoader](GLTFLoader.html)
...
### .[setMeshoptDecoder](#setMeshoptDecoder)( meshoptDecoder : Object ) : [GLTFLoader](GLTFLoader.html)
...
### .[unregister](#unregister)( callback : function ) : [GLTFLoader](GLTFLoader.html)
