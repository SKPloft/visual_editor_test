Title: PCDLoader
Source URL: https://threejs.org/docs/pages/PCDLoader.html
...
### new [PCDLoader](#PCDLoader)( manager : [LoadingManager](LoadingManager.html) )
...
### .[littleEndian](#littleEndian) : boolean
...
### .[parse](#parse)( data : ArrayBuffer ) : [Points](Points.html)
