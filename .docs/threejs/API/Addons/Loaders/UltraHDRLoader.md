...
Source URL: https://threejs.org/docs/pages/UltraHDRLoader.html
...
### new [UltraHDRLoader](#UltraHDRLoader)( manager : [LoadingManager](LoadingManager.html) )
...
### .[load](#load)( url : string, onLoad : function, onProgress : [onProgressCallback](global.html#onProgressCallback), onError : [onErrorCallback](global.html#onErrorCallback) ) : [DataTexture](DataTexture.html)
...
### .[parse](#parse)( buffer : ArrayBuffer, onLoad : function )
...
### .[setDataType](#setDataType)( value : [HalfFloatType](global.html#HalfFloatType) | [FloatType](global.html#FloatType) ) : [UltraHDRLoader](UltraHDRLoader.html)
