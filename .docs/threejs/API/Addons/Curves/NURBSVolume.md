Title: NURBSVolume
Source URL: https://threejs.org/docs/pages/NURBSVolume.html
...
### new [NURBSVolume](#NURBSVolume)( degree1 : number, degree2 : number, degree3 : number, knots1 : Array.<number>, knots2 : Array.<number>, knots3 : Array.<number>, controlPoints : Array.<Array.<Array.<([Vector2](Vector2.html)|[Vector3](Vector3.html)|[Vector4](Vector4.html))>>> )
...
### .[getPoint](#getPoint)( t1 : number, t2 : number, t3 : number, target : [Vector3](Vector3.html) )
