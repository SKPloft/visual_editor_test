Title: LatheGeometry
Source URL: https://threejs.org/docs/pages/LatheGeometry.html
...
### new [LatheGeometry](#LatheGeometry)( points : Array.<([Vector2](Vector2.html)|[Vector3](Vector3.html))>, segments : number, phiStart : number, phiLength : number )
...
### .[fromJSON](#.fromJSON)( data : Object ) : [LatheGeometry](LatheGeometry.html)
