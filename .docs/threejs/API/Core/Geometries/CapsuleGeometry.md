...
Source URL: https://threejs.org/docs/pages/CapsuleGeometry.html
...
### new [CapsuleGeometry](#CapsuleGeometry)( radius : number, height : number, capSegments : number, radialSegments : number, heightSegments : number )
...
### .[fromJSON](#.fromJSON)( data : Object ) : [CapsuleGeometry](CapsuleGeometry.html)
