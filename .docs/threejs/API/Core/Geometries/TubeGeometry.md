Title: TubeGeometry
Source URL: https://threejs.org/docs/pages/TubeGeometry.html
...
### new [TubeGeometry](#TubeGeometry)( path : [Curve](Curve.html), tubularSegments : number, radius : number, radialSegments : number, closed : boolean )
...
### .[fromJSON](#.fromJSON)( data : Object ) : [TubeGeometry](TubeGeometry.html)
