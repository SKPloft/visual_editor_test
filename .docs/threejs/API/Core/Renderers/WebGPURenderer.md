...
Source URL: https://threejs.org/docs/pages/WebGPURenderer.html
...
### new [WebGPURenderer](#WebGPURenderer)( parameters : [WebGPURenderer~Options](WebGPURenderer.html#~Options) )
...
### .[isWebGPURenderer](#isWebGPURenderer) : boolean (readonly)

This flag can be used for type testing.

Default is `true`.

### .[library](#library) : [StandardNodeLibrary](StandardNodeLibrary.html)
