Title: Renderer
Source URL: https://threejs.org/docs/pages/Renderer.html
...
### new [Renderer](#Renderer)( backend : [Backend](Backend.html), parameters : [Renderer~Options](Renderer.html#~Options) )
...
### .[coordinateSystem](#coordinateSystem) : number (readonly)
...
### .[currentColorSpace](#currentColorSpace) : string
...
### .[currentSamples](#currentSamples) : number
...
### .[domElement](#domElement) : HTMLCanvasElement | OffscreenCanvas
...
### .[highPrecision](#highPrecision) : boolean
...
### .[initialized](#initialized) (readonly)

Returns whether the renderer has been initialized or not.

### .[inspector](#inspector) : [InspectorBase](InspectorBase.html)
...
### .[isRenderer](#isRenderer) : boolean (readonly)

This flag can be used for type testing.

Default is `true`.

### .[library](#library) : [NodeLibrary](NodeLibrary.html)
...
### .[lighting](#lighting) : [Lighting](Lighting.html)

A map-like data structure for managing lights.

### .[logarithmicDepthBuffer](#logarithmicDepthBuffer) : boolean (readonly)

Whether logarithmic depth buffer is enabled or not.

Default is `false`.

### .[needsFrameBufferTarget](#needsFrameBufferTarget)
...
### .[onDeviceLost](#onDeviceLost) : function
...
### .[outputColorSpace](#outputColorSpace) : string

Defines the output color space of the renderer.

Default is `SRGBColorSpace`.

### .[reversedDepthBuffer](#reversedDepthBuffer) : boolean (readonly)
...
### .[shadowMap](#shadowMap) : [ShadowMapConfig](global.html#ShadowMapConfig)

The renderer's shadow configuration.

### .[sortObjects](#sortObjects) : boolean
...
### .[xr](#xr) : [XRManager](XRManager.html)

The renderer's XR manager.

## Methods

### .[clear](#clear)( color : boolean, depth : boolean, stencil : boolean )
...
### .[clearAsync](#clearAsync)( color : boolean, depth : boolean, stencil : boolean ) : Promise (async)
...
### .[clearColorAsync](#clearColorAsync)() : Promise (async)
...
### .[clearDepthAsync](#clearDepthAsync)() : Promise (async)
...
### .[clearStencilAsync](#clearStencilAsync)() : Promise (async)
...
### .[compile](#compile)( scene : [Object3D](Object3D.html), camera : [Camera](Camera.html), targetScene : [Scene](Scene.html) ) : function
...
### .[compileAsync](#compileAsync)( scene : [Object3D](Object3D.html), camera : [Camera](Camera.html), targetScene : [Scene](Scene.html) ) : Promise (async)
...
### .[compute](#compute)( computeNodes : [Node](Node.html) | Array.<[Node](Node.html)\>, dispatchSize : number | Array.<number> | [IndirectStorageBufferAttribute](IndirectStorageBufferAttribute.html) ) : Promise | undefined
...
### .[computeAsync](#computeAsync)( computeNodes : [Node](Node.html) | Array.<[Node](Node.html)\>, dispatchSize : number | Array.<number> | [IndirectStorageBufferAttribute](IndirectStorageBufferAttribute.html) ) : Promise (async)
...
### .[copyFramebufferToTexture](#copyFramebufferToTexture)( framebufferTexture : [FramebufferTexture](FramebufferTexture.html), rectangle : [Vector2](Vector2.html) | [Vector4](Vector4.html) )
...
### .[copyTextureToTexture](#copyTextureToTexture)( srcTexture : [Texture](Texture.html), dstTexture : [Texture](Texture.html), srcRegion : [Box2](Box2.html) | [Box3](Box3.html), dstPosition : [Vector2](Vector2.html) | [Vector3](Vector3.html), srcLevel : number, dstLevel : number )
...
### .[getActiveCubeFace](#getActiveCubeFace)() : number

Returns the active cube face.

**Returns:** The active cube face.

### .[getActiveMipmapLevel](#getActiveMipmapLevel)() : number

Returns the active mipmap level.

**Returns:** The active mipmap level.

### .[getAnimationLoop](#getAnimationLoop)() : function

Returns the current animation loop callback.

**Returns:** The current animation loop callback.

### .[getArrayBufferAsync](#getArrayBufferAsync)( attribute : [BufferAttribute](BufferAttribute.html), target : [ReadbackBuffer](ReadbackBuffer.html) | ArrayBuffer, offset : number, count : number ) : Promise.<(ArrayBuffer|[ReadbackBuffer](ReadbackBuffer.html))> (async)
...
### .[getCanvasTarget](#getCanvasTarget)() : [CanvasTarget](CanvasTarget.html)

Returns the current canvas target.

**Returns:** The current canvas target.

### .[getClearAlpha](#getClearAlpha)() : number

Returns the clear alpha.

**Returns:** The clear alpha.

### .[getClearColor](#getClearColor)( target : [Color](Color.html) ) : [Color](Color.html)
...
### .[getClearDepth](#getClearDepth)() : number

Returns the clear depth.

**Returns:** The clear depth.

### .[getClearStencil](#getClearStencil)() : number

Returns the clear stencil.

**Returns:** The clear stencil.

### .[getColorBufferType](#getColorBufferType)() : number
...
### .[getContext](#getContext)() : GPUCanvasContext | WebGL2RenderingContext

Returns the rendering context.

**Returns:** The rendering context.

### .[getDrawingBufferSize](#getDrawingBufferSize)( target : [Vector2](Vector2.html) ) : [Vector2](Vector2.html)
...
### .[getMRT](#getMRT)() : [MRTNode](MRTNode.html)

Returns the MRT configuration.

**Returns:** The MRT configuration.

### .[getMaxAnisotropy](#getMaxAnisotropy)() : number

Returns the maximum available anisotropy for texture filtering.

**Returns:** The maximum available anisotropy.

### .[getOutputBufferType](#getOutputBufferType)() : number

Returns the output buffer type.

**Returns:** The output buffer type.

### .[getOutputRenderTarget](#getOutputRenderTarget)() : [RenderTarget](RenderTarget.html)

Returns the current output target.

**Returns:** The current output render target. Returns `null` if no output target is set.

### .[getPixelRatio](#getPixelRatio)() : number

Returns the pixel ratio.

**Returns:** The pixel ratio.

### .[getRenderObjectFunction](#getRenderObjectFunction)() : function

Returns the current render object function.

**Returns:** The current render object function. Returns `null` if no function is set.

### .[getRenderTarget](#getRenderTarget)() : [RenderTarget](RenderTarget.html)

Returns the current render target.

**Returns:** The render target. Returns `null` if no render target is set.

### .[getScissor](#getScissor)( target : [Vector4](Vector4.html) ) : [Vector4](Vector4.html)
...
### .[getScissorTest](#getScissorTest)() : boolean

Returns the scissor test value.

**Returns:** Whether the scissor test should be enabled or not.

### .[getSize](#getSize)( target : [Vector2](Vector2.html) ) : [Vector2](Vector2.html)
...
### .[getViewport](#getViewport)( target : [Vector4](Vector4.html) ) : [Vector4](Vector4.html)
...
### .[hasCompatibility](#hasCompatibility)( name : string ) : boolean
...
### .[hasFeature](#hasFeature)( name : string ) : boolean
...
### .[hasFeatureAsync](#hasFeatureAsync)( name : string ) : Promise.<boolean> (async)
...
### .[init](#init)() : Promise.<this> (async)

Initializes the renderer so it is ready for usage.

**Returns:** A Promise that resolves when the renderer has been initialized.

### .[initRenderTarget](#initRenderTarget)( renderTarget : [RenderTarget](RenderTarget.html) )
...
### .[initTexture](#initTexture)( texture : [Texture](Texture.html) )
...
### .[initTextureAsync](#initTextureAsync)( texture : [Texture](Texture.html) ) : Promise (async)
...
### .[isOccluded](#isOccluded)( object : [Object3D](Object3D.html) ) : boolean
...
### .[readRenderTargetPixelsAsync](#readRenderTargetPixelsAsync)( renderTarget : [RenderTarget](RenderTarget.html), x : number, y : number, width : number, height : number, textureIndex : number, faceIndex : number ) : Promise.<TypedArray> (async)
...
### .[render](#render)( scene : [Object3D](Object3D.html), camera : [Camera](Camera.html) )
...
### .[renderAsync](#renderAsync)( scene : [Object3D](Object3D.html), camera : [Camera](Camera.html) ) : Promise (async)
...
### .[renderObject](#renderObject)( object : [Object3D](Object3D.html), scene : [Scene](Scene.html), camera : [Camera](Camera.html), geometry : [BufferGeometry](BufferGeometry.html), material : [Material](Material.html), group : Object, lightsNode : [LightsNode](LightsNode.html), clippingContext : [ClippingContext](ClippingContext.html), passId : string )
...
### .[setAnimationLoop](#setAnimationLoop)( callback : [onAnimationCallback](global.html#onAnimationCallback) ) : Promise (async)
...
### .[setCanvasTarget](#setCanvasTarget)( canvasTarget : [CanvasTarget](CanvasTarget.html) )
...
### .[setClearAlpha](#setClearAlpha)( alpha : number )
...
### .[setClearColor](#setClearColor)( color : [Color](Color.html), alpha : number )
...
### .[setClearDepth](#setClearDepth)( depth : number )
...
### .[setClearStencil](#setClearStencil)( stencil : number )
...
### .[setDrawingBufferSize](#setDrawingBufferSize)( width : number, height : number, pixelRatio : number )
...
### .[setMRT](#setMRT)( mrt : [MRTNode](MRTNode.html) ) : [Renderer](Renderer.html)
...
### .[setOpaqueSort](#setOpaqueSort)( method : function )
...
### .[setOutputRenderTarget](#setOutputRenderTarget)( renderTarget : [RenderTarget](RenderTarget.html) )
...
### .[setPixelRatio](#setPixelRatio)( value : number )
...
### .[setRenderObjectFunction](#setRenderObjectFunction)( renderObjectFunction : [renderObjectFunction](global.html#renderObjectFunction) )
...
### .[setRenderTarget](#setRenderTarget)( renderTarget : [RenderTarget](RenderTarget.html), activeCubeFace : number, activeMipmapLevel : number )
...
### .[setScissor](#setScissor)( x : number | [Vector4](Vector4.html), y : number, width : number, height : number )
...
### .[setScissorTest](#setScissorTest)( boolean : boolean )
...
### .[setSize](#setSize)( width : number, height : number, updateStyle : boolean )
...
### .[setTransparentSort](#setTransparentSort)( method : function )
...
### .[setViewport](#setViewport)( x : number | [Vector4](Vector4.html), y : number, width : number, height : number, minDepth : number, maxDepth : number )
...
### .[waitForGPU](#waitForGPU)() : Promise (async)
