Title: WebGPUTimestampQueryPool
Source URL: https://threejs.org/docs/pages/WebGPUTimestampQueryPool.html
...
### new [WebGPUTimestampQueryPool](#WebGPUTimestampQueryPool)( device : GPUDevice, type : string, maxQueries : number )
