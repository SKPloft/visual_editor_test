Title: CubeCamera
Source URL: https://threejs.org/docs/pages/CubeCamera.html
...
### new [CubeCamera](#CubeCamera)( near : number, far : number, renderTarget : [WebGLCubeRenderTarget](WebGLCubeRenderTarget.html) )
...
### .[activeMipmapLevel](#activeMipmapLevel) : number
...
### .[renderTarget](#renderTarget) : [WebGLCubeRenderTarget](WebGLCubeRenderTarget.html)

A reference to the cube render target.

## Methods

### .[update](#update)( renderer : [Renderer](Renderer.html) | [WebGLRenderer](WebGLRenderer.html), scene : [Scene](Scene.html) )
