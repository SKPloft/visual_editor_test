Title: Matrix4
Source URL: https://threejs.org/docs/pages/Matrix4.html
...
### new [Matrix4](#Matrix4)( n11 : number, n12 : number, n13 : number, n14 : number, n21 : number, n22 : number, n23 : number, n24 : number, n31 : number, n32 : number, n33 : number, n34 : number, n41 : number, n42 : number, n43 : number, n44 : number )
...
### .[elements](#elements) : Array.<number>

A column-major list of matrix values.

## Methods

### .[clone](#clone)() : [Matrix4](Matrix4.html)

Returns a matrix with copied values from this instance.

**Returns:** A clone of this instance.

### .[compose](#compose)( position : [Vector3](Vector3.html), quaternion : [Quaternion](Quaternion.html), scale : [Vector3](Vector3.html) ) : [Matrix4](Matrix4.html)
...
### .[copy](#copy)( m : [Matrix4](Matrix4.html) ) : [Matrix4](Matrix4.html)
...
### .[copyPosition](#copyPosition)( m : [Matrix4](Matrix4.html) ) : [Matrix4](Matrix4.html)
...
### .[decompose](#decompose)( position : [Vector3](Vector3.html), quaternion : [Quaternion](Quaternion.html), scale : [Vector3](Vector3.html) ) : [Matrix4](Matrix4.html)
...
### .[equals](#equals)( matrix : [Matrix4](Matrix4.html) ) : boolean
...
### .[extractBasis](#extractBasis)( xAxis : [Vector3](Vector3.html), yAxis : [Vector3](Vector3.html), zAxis : [Vector3](Vector3.html) ) : [Matrix4](Matrix4.html)
...
### .[extractRotation](#extractRotation)( m : [Matrix4](Matrix4.html) ) : [Matrix4](Matrix4.html)
...
### .[fromArray](#fromArray)( array : Array.<number>, offset : number ) : [Matrix4](Matrix4.html)
...
### .[getMaxScaleOnAxis](#getMaxScaleOnAxis)() : number

Gets the maximum scale value of the three axes.

**Returns:** The maximum scale.

### .[identity](#identity)() : [Matrix4](Matrix4.html)

Sets this matrix to the 4x4 identity matrix.

**Returns:** A reference to this matrix.

### .[invert](#invert)() : [Matrix4](Matrix4.html)
...
### .[lookAt](#lookAt)( eye : [Vector3](Vector3.html), target : [Vector3](Vector3.html), up : [Vector3](Vector3.html) ) : [Matrix4](Matrix4.html)
...
### .[makeBasis](#makeBasis)( xAxis : [Vector3](Vector3.html), yAxis : [Vector3](Vector3.html), zAxis : [Vector3](Vector3.html) ) : [Matrix4](Matrix4.html)
...
### .[makeOrthographic](#makeOrthographic)( left : number, right : number, top : number, bottom : number, near : number, far : number, coordinateSystem : [WebGLCoordinateSystem](global.html#WebGLCoordinateSystem) | [WebGPUCoordinateSystem](global.html#WebGPUCoordinateSystem), reversedDepth : boolean ) : [Matrix4](Matrix4.html)
...
### .[makePerspective](#makePerspective)( left : number, right : number, top : number, bottom : number, near : number, far : number, coordinateSystem : [WebGLCoordinateSystem](global.html#WebGLCoordinateSystem) | [WebGPUCoordinateSystem](global.html#WebGPUCoordinateSystem), reversedDepth : boolean ) : [Matrix4](Matrix4.html)
...
### .[makeRotationAxis](#makeRotationAxis)( axis : [Vector3](Vector3.html), angle : number ) : [Matrix4](Matrix4.html)
...
### .[makeRotationFromEuler](#makeRotationFromEuler)( euler : [Euler](Euler.html) ) : [Matrix4](Matrix4.html)
...
### .[makeRotationFromQuaternion](#makeRotationFromQuaternion)( q : [Quaternion](Quaternion.html) ) : [Matrix4](Matrix4.html)
...
### .[makeRotationX](#makeRotationX)( theta : number ) : [Matrix4](Matrix4.html)
...
### .[makeRotationY](#makeRotationY)( theta : number ) : [Matrix4](Matrix4.html)
...
### .[makeRotationZ](#makeRotationZ)( theta : number ) : [Matrix4](Matrix4.html)
...
### .[makeScale](#makeScale)( x : number, y : number, z : number ) : [Matrix4](Matrix4.html)
...
### .[makeShear](#makeShear)( xy : number, xz : number, yx : number, yz : number, zx : number, zy : number ) : [Matrix4](Matrix4.html)
...
### .[makeTranslation](#makeTranslation)( x : number | [Vector3](Vector3.html), y : number, z : number ) : [Matrix4](Matrix4.html)
...
### .[multiply](#multiply)( m : [Matrix4](Matrix4.html) ) : [Matrix4](Matrix4.html)
...
### .[multiplyMatrices](#multiplyMatrices)( a : [Matrix4](Matrix4.html), b : [Matrix4](Matrix4.html) ) : [Matrix4](Matrix4.html)
...
### .[multiplyScalar](#multiplyScalar)( s : number ) : [Matrix4](Matrix4.html)
...
### .[premultiply](#premultiply)( m : [Matrix4](Matrix4.html) ) : [Matrix4](Matrix4.html)
...
### .[scale](#scale)( v : [Vector3](Vector3.html) ) : [Matrix4](Matrix4.html)
...
### .[set](#set)( n11 : number, n12 : number, n13 : number, n14 : number, n21 : number, n22 : number, n23 : number, n24 : number, n31 : number, n32 : number, n33 : number, n34 : number, n41 : number, n42 : number, n43 : number, n44 : number ) : [Matrix4](Matrix4.html)
...
### .[setFromMatrix3](#setFromMatrix3)( m : [Matrix3](Matrix3.html) ) : [Matrix4](Matrix4.html)
...
### .[setPosition](#setPosition)( x : number | [Vector3](Vector3.html), y : number, z : number ) : [Matrix4](Matrix4.html)
...
### .[transpose](#transpose)() : [Matrix4](Matrix4.html)
