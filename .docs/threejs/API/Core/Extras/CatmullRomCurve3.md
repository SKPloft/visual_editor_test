...
Source URL: https://threejs.org/docs/pages/CatmullRomCurve3.html
...
### new [CatmullRomCurve3](#CatmullRomCurve3)( points : Array.<[Vector3](Vector3.html)\>, closed : boolean, curveType : 'centripetal' | 'chordal' | 'catmullrom', tension : number )
...
### .[isCatmullRomCurve3](#isCatmullRomCurve3) : boolean (readonly)

This flag can be used for type testing.

Default is `true`.

### .[points](#points) : Array.<[Vector3](Vector3.html)\>
