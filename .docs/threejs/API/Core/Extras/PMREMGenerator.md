...
Source URL: https://threejs.org/docs/pages/PMREMGenerator.html
...
### new [PMREMGenerator](#PMREMGenerator)( renderer : [WebGLRenderer](WebGLRenderer.html) )
...
### .[compileCubemapShader](#compileCubemapShader)()
...
### .[fromCubemap](#fromCubemap)( cubemap : [Texture](Texture.html), renderTarget : [WebGLRenderTarget](WebGLRenderTarget.html) ) : [WebGLRenderTarget](WebGLRenderTarget.html)
...
### .[fromEquirectangular](#fromEquirectangular)( equirectangular : [Texture](Texture.html), renderTarget : [WebGLRenderTarget](WebGLRenderTarget.html) ) : [WebGLRenderTarget](WebGLRenderTarget.html)
...
### .[fromScene](#fromScene)( scene : [Scene](Scene.html), sigma : number, near : number, far : number, options : Object ) : [WebGLRenderTarget](WebGLRenderTarget.html)
