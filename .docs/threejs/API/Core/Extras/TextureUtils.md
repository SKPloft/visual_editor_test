Title: TextureUtils
Source URL: https://threejs.org/docs/pages/TextureUtils.html
...
### .[contain](#.contain)( texture : [Texture](Texture.html), aspect : number ) : [Texture](Texture.html)
...
### .[cover](#.cover)( texture : [Texture](Texture.html), aspect : number ) : [Texture](Texture.html)
...
### .[fill](#.fill)( texture : [Texture](Texture.html) ) : [Texture](Texture.html)
...
### .[getByteLength](#.getByteLength)( width : number, height : number, format : number, type : number ) : number
