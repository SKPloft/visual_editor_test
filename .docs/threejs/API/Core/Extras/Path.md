Title: Path
Source URL: https://threejs.org/docs/pages/Path.html
...
### new [Path](#Path)( points : Array.<[Vector2](Vector2.html)\> )
...
### .[currentPoint](#currentPoint) : [Vector2](Vector2.html)

The current offset of the path. Any new curve added will start here.

## Methods

### .[absarc](#absarc)( aX : number, aY : number, aRadius : number, aStartAngle : number, aEndAngle : number, aClockwise : boolean ) : [Path](Path.html)
...
### .[absellipse](#absellipse)( aX : number, aY : number, xRadius : number, yRadius : number, aStartAngle : number, aEndAngle : number, aClockwise : boolean, aRotation : number ) : [Path](Path.html)
...
### .[arc](#arc)( aX : number, aY : number, aRadius : number, aStartAngle : number, aEndAngle : number, aClockwise : boolean ) : [Path](Path.html)
...
### .[bezierCurveTo](#bezierCurveTo)( aCP1x : number, aCP1y : number, aCP2x : number, aCP2y : number, aX : number, aY : number ) : [Path](Path.html)
...
### .[ellipse](#ellipse)( aX : number, aY : number, xRadius : number, yRadius : number, aStartAngle : number, aEndAngle : number, aClockwise : boolean, aRotation : number ) : [Path](Path.html)
...
### .[lineTo](#lineTo)( x : number, y : number ) : [Path](Path.html)
...
### .[moveTo](#moveTo)( x : number, y : number ) : [Path](Path.html)
...
### .[quadraticCurveTo](#quadraticCurveTo)( aCPx : number, aCPy : number, aX : number, aY : number ) : [Path](Path.html)
...
### .[setFromPoints](#setFromPoints)( points : Array.<[Vector2](Vector2.html)\> ) : [Path](Path.html)
...
### .[splineThru](#splineThru)( pts : Array.<[Vector2](Vector2.html)\> ) : [Path](Path.html)
