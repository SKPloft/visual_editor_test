Title: ShapePath
Source URL: https://threejs.org/docs/pages/ShapePath.html
...
### .[currentPath](#currentPath) : [Path](Path.html)

The current path that is being generated.

Default is `null`.

### .[subPaths](#subPaths) : Array.<[Path](Path.html)\>
...
### .[bezierCurveTo](#bezierCurveTo)( aCP1x : number, aCP1y : number, aCP2x : number, aCP2y : number, aX : number, aY : number ) : [ShapePath](ShapePath.html)
...
### .[lineTo](#lineTo)( x : number, y : number ) : [ShapePath](ShapePath.html)
...
### .[moveTo](#moveTo)( x : number, y : number ) : [ShapePath](ShapePath.html)
...
### .[quadraticCurveTo](#quadraticCurveTo)( aCPx : number, aCPy : number, aX : number, aY : number ) : [ShapePath](ShapePath.html)
...
### .[splineThru](#splineThru)( pts : Array.<[Vector2](Vector2.html)\> ) : [ShapePath](ShapePath.html)
...
### .[toShapes](#toShapes)( isCCW : boolean ) : Array.<[Shape](Shape.html)\>
