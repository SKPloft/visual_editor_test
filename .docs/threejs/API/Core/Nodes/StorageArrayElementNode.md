...
Source URL: https://threejs.org/docs/pages/StorageArrayElementNode.html
...
### new [StorageArrayElementNode](#StorageArrayElementNode)( storageBufferNode : [StorageBufferNode](StorageBufferNode.html), indexNode : [Node](Node.html) )
...
### .[isStorageArrayElementNode](#isStorageArrayElementNode) : boolean (readonly)

This flag can be used for type testing.

Default is `true`.

### .[storageBufferNode](#storageBufferNode) : [StorageBufferNode](StorageBufferNode.html)
