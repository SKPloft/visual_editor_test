Title: InputNode
Source URL: https://threejs.org/docs/pages/InputNode.html
...
### new [InputNode](#InputNode)( value : [any](global.html#any), nodeType : string )
...
### .[isInputNode](#isInputNode) : boolean (readonly)
...
### .[setPrecision](#setPrecision)( precision : 'low' | 'medium' | 'high' ) : [InputNode](InputNode.html)
