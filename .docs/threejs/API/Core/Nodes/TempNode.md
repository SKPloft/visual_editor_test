Title: TempNode
Source URL: https://threejs.org/docs/pages/TempNode.html
...
### new [TempNode](#TempNode)( nodeType : string )
...
### .[isTempNode](#isTempNode) : boolean (readonly)
...
### .[hasDependencies](#hasDependencies)( builder : [NodeBuilder](NodeBuilder.html) ) : boolean
