...
Source URL: https://threejs.org/docs/pages/RenderOutputNode.html
...
### new [RenderOutputNode](#RenderOutputNode)( colorNode : [Node](Node.html), toneMapping : number, outputColorSpace : string )
...
### .[isRenderOutputNode](#isRenderOutputNode) : boolean (readonly)
...
### .[getToneMapping](#getToneMapping)() : number

Gets the tone mapping type.

**Returns:** The tone mapping type.

### .[setToneMapping](#setToneMapping)( value : number ) : [ToneMappingNode](ToneMappingNode.html)
