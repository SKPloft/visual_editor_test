Title: ParameterNode
Source URL: https://threejs.org/docs/pages/ParameterNode.html
...
### new [ParameterNode](#ParameterNode)( nodeType : string, name : string )
...
### .[isParameterNode](#isParameterNode) : boolean (readonly)
