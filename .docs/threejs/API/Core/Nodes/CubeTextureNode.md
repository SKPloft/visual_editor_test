...
Source URL: https://threejs.org/docs/pages/CubeTextureNode.html
...
### new [CubeTextureNode](#CubeTextureNode)( value : [CubeTexture](CubeTexture.html), uvNode : [Node](Node.html).<vec3>, levelNode : [Node](Node.html).<int>, biasNode : [Node](Node.html).<float> )
...
### .[isCubeTextureNode](#isCubeTextureNode) : boolean (readonly)
...
### .[generateUV](#generateUV)( builder : [NodeBuilder](NodeBuilder.html), cubeUV : [Node](Node.html) ) : string
