...
Source URL: https://threejs.org/docs/pages/PointsNodeMaterial.html
...
### new [PointsNodeMaterial](#PointsNodeMaterial)( parameters : Object )
...
### .[isPointsNodeMaterial](#isPointsNodeMaterial) : boolean (readonly)

This flag can be used for type testing.

Default is `true`.

### .[sizeNode](#sizeNode) : [Node](Node.html).<vec2>
