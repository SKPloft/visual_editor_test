...
Source URL: https://threejs.org/docs/pages/PolarGridHelper.html
...
### new [PolarGridHelper](#PolarGridHelper)( radius : number, sectors : number, rings : number, divisions : number, color1 : number | [Color](Color.html) | string, color2 : number | [Color](Color.html) | string )
