Title: LoaderUtils
Source URL: https://threejs.org/docs/pages/LoaderUtils.html
...
### .[extractUrlBase](#.extractUrlBase)( url : string ) : string
...
### .[resolveURL](#.resolveURL)( url : string, path : string ) : string
