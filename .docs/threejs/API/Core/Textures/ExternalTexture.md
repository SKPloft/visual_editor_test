...
Source URL: https://threejs.org/docs/pages/ExternalTexture.html
...
### new [ExternalTexture](#ExternalTexture)( sourceTexture : WebGLTexture | GPUTexture )
...
### .[isExternalTexture](#isExternalTexture) : boolean (readonly)

This flag can be used for type testing.

Default is `true`.

### .[sourceTexture](#sourceTexture) : WebGLTexture | GPUTexture
