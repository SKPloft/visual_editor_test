...
Source URL: https://threejs.org/docs/pages/InstancedInterleavedBuffer.html
...
### new [InstancedInterleavedBuffer](#InstancedInterleavedBuffer)( array : TypedArray, stride : number, meshPerAttribute : number )
...
### .[isInstancedInterleavedBuffer](#isInstancedInterleavedBuffer) : boolean (readonly)
