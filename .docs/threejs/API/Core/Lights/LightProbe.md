Title: LightProbe
Source URL: https://threejs.org/docs/pages/LightProbe.html
...
### new [LightProbe](#LightProbe)( sh : [SphericalHarmonics3](SphericalHarmonics3.html), intensity : number )
...
### .[isLightProbe](#isLightProbe) : boolean (readonly)

This flag can be used for type testing.

Default is `true`.

### .[sh](#sh) : [SphericalHarmonics3](SphericalHarmonics3.html)
