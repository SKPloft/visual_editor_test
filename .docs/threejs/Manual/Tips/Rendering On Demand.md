Title: en/rendering-on-demand
Source URL: https://threejs.org/manual/en/rendering-on-demand.html

The topic might be obvious to many people but just in case ... most Three.js examples render continuously. In other words they setup a `requestAnimationFrame` loop or "_rAF loop_" something like this
